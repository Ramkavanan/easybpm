...
public class InternalMessage extends BaseObject implements Serializable {
	 ...
	 */
	@Column(name = "FROM_USER_ID" , columnDefinition="LONGTEXT")
	 ...
	 * @return the cc
	 */
	@Column(name = "CC_ADDRESS" , columnDefinition="LONGTEXT")
	public String getCc() {
		return ccAddress;
	}
	/**
	 ...
	 * @return the bcc
	 */
	@Column(name = "BCC_ADDRESS" , columnDefinition="LONGTEXT")
	 ...
	 */
	@Column(name = "MESSAGE_SEND_ON" , columnDefinition = "DATETIME")
