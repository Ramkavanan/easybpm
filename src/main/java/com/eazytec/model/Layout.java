...
/**
 * This class used to represents the available layout in database for home screen
 * @author revathi
 *
 */
@Entity
...
public class Layout extends BaseObject{
	...
	//private String firstColumnWidget;
	//private String secondColumnWidget;
	 ...
	 * @param assignedTo
	 */
	 public Layout(String name, int noOfWidget, boolean status,
			String columnWidget, String menuType, String menuLink,
			String assignedTo) {
		super();
		this.name = name;
