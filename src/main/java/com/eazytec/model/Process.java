...
public class Process implements Serializable, HasRevision {
	...
	@Column(name = "IS_SYSTEM_DEFINED_", columnDefinition = "boolean default false")
    ...
    @Column(name = "REV_", nullable = false, length = 50, columnDefinition = "boolean default false")
    @Field
	...
	@Column(name = "HAS_START_FORM_KEY_", length = 40)
	...
	@Column(name = "IS_ACTIVE_VERSION_", length = 40)
