...
/**
 * <p>The custom Naming Strategy necessary for the BPM with respect to hibernate DB
 * functionalities are included here, for instance, prefixing a global string for all
 * table names</p>
 *
 * @author madan
 */
