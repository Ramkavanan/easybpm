...
@WebService(serviceName = "GroupService", endpointInterface = "com.eazytec.bpm.admin.group.service")
public class GroupServiceImpl extends GenericManagerImpl<Group, String> implements
	 ...
	 * {@inheritDoc}
	 */
	public List<Group> search(String searchTerm) {
		return super.search(searchTerm, Group.class);
	}
