...
@WebService(serviceName = "ModuleService", endpointInterface = "com.eazytec.bpm.admin.module.service")
public class ModuleServiceImpl extends GenericManagerImpl<Module, String> implements ModuleService{
	...
	/**
	 ...
	 private String constructFormDump(Set<MetaForm>  metaForms)throws EazyBpmException{
		 ...
		 for(MetaForm metaForm:metaForms){
			 ...
			 if(metaForm.isActive()){
				 formDump.append("('"+metaForm.getId()+"',"+metaForm.isActive()+",'"+user+"','"+DateUtil.convertDateToString(createdOn)+"','"+metaForm.getEnglishName()+"','"+metaForm.getFormName()+"','"+metaForm.getHtmlSource().replace("'", "\\'"));
	 ...
	 private String constructModuleDumps(Module module)throws EazyBpmException{
		 ...
		 moduleDump.append("'"+module.getId()+"','"+user.getUsername()+"','"+DateUtil.convertDateToString(createdOn)+"','"+module.getDescription().replace("'","")+"'," +
		 		""+module.getIsPublic()+","+module.getIsSystemModule()+","+module.getModuleOrder()+",'"+module.getName()+"','"+module.getUpdatedBy()+"','"+DateUtil.convertDateToString(createdOn)+"');");
		 moduleDump.append("\n\n\n\n");
