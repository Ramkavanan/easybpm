...
public interface DepartmentService {
     ...
     * @return Group
     */
    Department getDepartment(@PathParam("id") String departmentId);
     ...
     */
    Department getDepartmentByName(@PathParam("departmentName") String departmentName);
    ...
    */
	...
	public Department getDepartmentIdByDepartmentRole(String roleId);
	 ...
	 /**
	  * remove the department for given department name via API
	  * @param departmentId
	  * @param userName
	  * @throws ApiException
	  */	 
	 ...
	 @Path("{departmentName}")
	 @PreAuthorize("hasRole('ROLE_ADMIN')")
	 Response removeDepartmentByAPI(@PathParam("departmentName") String departmentId, @QueryParam("userName") String userName)  throws ApiException;
	 
	 /**
	  * show the department for given department name via API
	 ...
	 @Produces(MediaType.APPLICATION_JSON)
	 @PreAuthorize("hasRole('ROLE_ADMIN')")
	 Department getDepartmentByNameForAPI(@PathParam("departmentName") String departmentName); 
}
