...
@WebService(serviceName = "NotificationService", endpointInterface = "com.eazytec.bpm.admin.notification.service")
	...
	private Map<String, Object> sendNotification(Map<String, Object> resultMap, String notificationType, List<String> recipients, String subject, String body){
		if(!recipients.isEmpty()){
			if(notificationType.equalsIgnoreCase(Constants.NOTIFICATION_SMS_TYPE)){
	    		...
	    		resultMap = mailEngine.sendInternalMessage(recipients.toArray(new String[recipients.size()]), subject, body);
	    	}
		}
		return resultMap;
	}
