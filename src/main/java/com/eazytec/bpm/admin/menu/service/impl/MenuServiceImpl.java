 ...
 */
@Service("menuService")
@WebService(serviceName = "MenuService", endpointInterface = "com.eazytec.bpm.admin.menu.service")
public class MenuServiceImpl extends GenericManagerImpl<Menu, String> implements MenuService {
	 ...
	 * {@inheritDoc}
	 */
	public List<Menu> search(String searchTerm) {
		return super.search(searchTerm, Menu.class);
	}
