...
public class DataSourceUtil {
	...
	public static boolean isColumnTextType(String columnType){
		if(columnType.equalsIgnoreCase("varchar") || columnType.equalsIgnoreCase("text") || columnType.equalsIgnoreCase("date") || columnType.equalsIgnoreCase("time")
				|| columnType.equalsIgnoreCase("char") || columnType.equalsIgnoreCase("tinyblob")) {
			return true;
		}
		return false;
	  }
	...
	public static boolean isColumnDateType(String columnType){
		  return columnType.contains("date")||columnType.contains("DATE");
	  }
	...
	public static boolean isColumnByteType(String columnType){
		  return (columnType.equalsIgnoreCase("longtext")||columnType.equalsIgnoreCase("longblob")||columnType.equalsIgnoreCase("blob")||columnType.equalsIgnoreCase("text")
				  ||columnType.equalsIgnoreCase("mediumblob")||columnType.equalsIgnoreCase("mediumText")||columnType.equalsIgnoreCase("tinytext"));
	  }
