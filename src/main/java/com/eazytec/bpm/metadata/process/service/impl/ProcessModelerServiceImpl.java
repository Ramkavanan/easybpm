...
@WebService(serviceName = "ProcessModelerService", endpointInterface = "com.eazytec.bpm.metadata.process.service")
public class ProcessModelerServiceImpl implements ProcessModelerService {
	...
	@Override
	public boolean createProcess(HttpServletRequest request,String processName,String classificationId,ServletContext getServletContext) throws Exception {
		...
		boolean isDeployed = processDefinitionService.deployBPMNSourceFileWithJson(
				processName+".bpmn20.xml", fileNameWithPath,description,classificationId, jsonData, svgDOM);
