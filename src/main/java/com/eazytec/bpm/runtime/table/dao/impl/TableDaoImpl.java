...
public class TableDaoImpl extends GenericDaoHibernate<MetaTable, String> implements TableDao {
	...
	public void setDataBaseSchemaName(String dataBaseSchemaName) {
		...
		public List<String> getAllColumnsByTableName(String tableName)throws EazyBpmException{
			String selectAllData="SELECT tab.column_name AS columnName FROM information_schema.columns AS tab WHERE tab.table_schema = '"+dataBaseSchemaName+"' AND tab.TABLE_NAME='"+tableName+"'";
		...
		/**
		  *{@inheritDoc}
		 */
		public void deleteAllNoticeByIds(String noticeIdList)throws EazyBpmException{
			String noticeIds="delete from NOTICE where id in "+noticeIdList;
		...
		/**
		  *{@inheritDoc}
		 */
		public void deleteAllNewsByIds(String newsIdList)throws EazyBpmException{
			String newsQuery = "delete from NEWS where id in "+newsIdList;
		...
		public List<String> getTableNamesByProcessIds(String executionId)throws EazyBpmException{
			String tableQuery="SELECT proTable.TABLE_NAME_ from ETEC_RE_PROCESS_TABLE_DETAILS as proTable where proTable.PROC_INST_ID_ = '"+executionId+"'";
		...
		public List<String> getAllMetaTable()throws EazyBpmException{
			String selectAllData="SELECT tab.TABLE_NAME AS tableName FROM INFORMATION_SCHEMA.TABLES AS tab WHERE tab.table_schema = '"+dataBaseSchemaName+"' AND (tab.TABLE_NAME LIKE 'ETEC_%' OR tab.TABLE_NAME LIKE 'QRTZ_%')";
			Query query = getSession().createSQLQuery(selectAllData);
			getSession().flush();
			return (List<String>) query.list();
	    }
