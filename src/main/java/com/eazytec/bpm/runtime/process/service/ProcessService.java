...
public interface ProcessService {	
     ...
     * @return
     */
    boolean saveClassification(Classification classification,HttpServletRequest request) throws BpmException;
	...
	@Path("{name}")
    @PreAuthorize("hasRole('ROLE_ADMIN')")
	Response deleteProcessForAPI(@PathParam("name") String id);
	
	@POST
	@Consumes(MediaType.APPLICATION_JSON)
    @PreAuthorize("hasRole('ROLE_ADMIN')")
	Response startProcessForAPI(String processKey);
