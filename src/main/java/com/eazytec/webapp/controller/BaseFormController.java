...
/**
 * Implementation of SimpleFormController that contains convenience 
 * methods for subclasses. For example, getting the current user and 
 * saving messages/errors. Intended to be a base class for all Form controllers.
 *
 * @author madan
 */
public class BaseFormController implements ServletContextAware {
    ...
    protected void initBinder(HttpServletRequest request,
    	...
    	MDC.put("userName",CommonUtil.getLoggedInUser());
    }
