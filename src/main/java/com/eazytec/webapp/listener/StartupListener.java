...
import com.eazytec.bpm.common.util.DocConverter;
...
//        log.info("Starting Server");
    ...
    public static void setupContext(ServletContext context) {
        ...
        Map<String, String> usersMap=mgr.getAllUsersAsMap();
...
//				log.info("Loading OpenOffice Path");
				DocConverter.getInstance().start();
			} else {
//				log.warn("OpenOffice Path Not Configured");
			}
		} catch (Throwable e) {
...
//        log.info("Full text search reindexing complete [OK]");
    }
