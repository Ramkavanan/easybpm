...
/**
 * Hold functions commonly used for conversions, manipulations and other utility functions.
 *  
 * @author Karthick
 * @author madan
 * @author revathi
...
public class CommonUtil {	
	 ...
	 * @param requestMap the map which needs to be parsed
	...
	/**
	 * <p>Gets the string representation of each object value in a map represented as generic object,
	 * but the value will be string only</p>
	 * @param requestMap the raw map
	...
	public static Map<String, Object> getStringRepresentations (Map<String,Object> requestMap){
		...
		while(param.hasNext()){
			...
			if(value!=null){
				if(ResourceBundle.getBundle(Constants.BUNDLE_KEY, locale)
	                    .getString("date.class").equals(value.getClass().getName())){
					resultMap.put(key, DateUtil.convertDateToString((Date)value));
				}else{
					resultMap.put(key, value.toString());
				}
				//TO-DO: Add for other types that may need similar special conversions.
			}								
		}
		return resultMap;
	}
   ...
   public static String generateHomePageScript(VelocityEngine velocityEngine, Map<String, Object> context){
		  String result = null;
	        try {
	            ...
	            result = 
	                VelocityEngineUtils.mergeTemplateIntoString(velocityEngine, "com/eazytec/bpm/form/templates/homePage.vm", context);
   ...
   public static List<Map<String, Object>> createImportFilesRootTreeNode(List<Map<String, Object>> nodeListOfMap, String name, String id, String data,String resourcePath) throws BpmException, Exception{
	 ...
	 */
	 ...
	 public static String getInternalMessageDomain(){
		 return (String) PropertyReader.getInstance()
			.getPropertyFromFile("String", "system.app.internalMessage.domain");
	 }
	 
	 public static String getInternalMessageSMTPProtocol(){
		 return (String) PropertyReader.getInstance()
			.getPropertyFromFile("String", "system.app.internalMessage.smtp.protocol");
	 }
	 
	 public static String getInternalMessageSMTPHost(){
		 return (String) PropertyReader.getInstance()
			.getPropertyFromFile("String", "system.app.internalMessage.smtp.host");
	 }
	 
	 public static int getInternalMessageSMTPPort(){
		return Integer.parseInt(PropertyReader.getInstance().getPropertyFromFile("Integer", "system.app.internalMessage.smtp.port"));
	 }
	 
	 public static String getInternalMessageIMAPProtocol(){
		 return (String) PropertyReader.getInstance()
					.getPropertyFromFile("String", "system.app.internalMessage.imap.protocol");
	 }
	 
	 public static String getInternalMessageIMAPHost(){
		 return (String) PropertyReader.getInstance()
			.getPropertyFromFile("String", "system.app.internalMessage.imap.host");
	 }
	 
	 public static int getInternalMessageIMAPPort(){
		return Integer.parseInt(PropertyReader.getInstance().getPropertyFromFile("Integer", "system.app.internalMessage.imap.port"));
	 }
	 
	 public static Boolean getInternalMessageSSL(){
		 return Boolean.valueOf(PropertyReader.getInstance()
					.getPropertyFromFile("Boolean", "system.app.internalMessage.ssl"));
	 }
	 ...
	 public static String getInternalMessageNotificationAdminName(){
		 return (String) PropertyReader.getInstance()
			.getPropertyFromFile("String", "system.app.internalMessage.notification.admin");
	 }
	 
	 public static String getEmailNotificationId(){
		 return (String) PropertyReader.getInstance()
			.getPropertyFromFile("String", "system.notification.email");
	 }
	 
	 public static String getEmailNotificationPassword(){
		 return (String) PropertyReader.getInstance()
			.getPropertyFromFile("String", "system.notification.password");
	 }
	 
	 public static String getInternalMessageNotificationAdminId(){
		 return getInternalMessageId(getInternalMessageNotificationAdminName());
	 }
	 ...
	 public static String getEazytecTimeZone(){
		 return (String) PropertyReader.getInstance()
			.getPropertyFromFile("String", "system.app.timezone.id");
	 }
