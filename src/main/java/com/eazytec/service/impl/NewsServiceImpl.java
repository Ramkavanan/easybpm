 ...
 */
@Service("newsService")
@WebService(serviceName = "NewsService", endpointInterface = "com.eazytec.service")
	...
	public List<Map<String, Object>> getNewsItemForHomePage() throws Exception{
		...
		if(newsItems != null && !newsItems.isEmpty()){
			for(Object[] newsItem : newsItems){
				...
				Date dateTime = DateUtil.convertStringToDate("yyyy-MM-dd HH:mm:ss.SSSSSS", String.valueOf(newsItem[2]));
	  			String dateStr = DateUtil.convertDateToString(dateTime);
				newsMap.put("CREATEDTIME", dateStr);
				newsMap.put("Information", newsItem[3]);
