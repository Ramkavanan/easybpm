 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.eazytec.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, String> implements UserManager, UserService {
     ...
     * {@inheritDoc}
     */
 public Response deleteUserForAPI(String deleteUserName,String userName){
    	
    	User user = getUser(userName);
    	List<String> userIdList = new ArrayList<String>();
    	userIdList.add(deleteUserName);
    	try{
    		String notDeletedUsers = deleteSelectedUsers(userIdList,user);
    		if(notDeletedUsers == null){
    			...
    			//throw new ApiException(200,"User Deleted successfully");
    		}
    	}catch(Exception e){
    		e.printStackTrace();
