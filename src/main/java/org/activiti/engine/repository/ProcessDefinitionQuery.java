...
public interface ProcessDefinitionQuery extends Query<ProcessDefinitionQuery, ProcessDefinition> {
  ...
  /**
   * Only selects process definitions which are currently active version
   */
  ProcessDefinitionQuery activeVersion();
  ...
  ProcessDefinitionQuery modules(List<Module>modules);
