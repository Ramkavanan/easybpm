...
public interface DeploymentBuilder {
  ...
  DeploymentBuilder addInputStream(String resourceName, InputStream inputStream, String jsonString);
  DeploymentBuilder addInputStream(String resourceName, InputStream inputStream, String jsonString,String svgString);
  DeploymentBuilder addInputStream(String deploymentName, String resourceName, InputStream inputStream);
