...
public class ExecutionEntity extends VariableScopeImpl implements ActivityExecution, ExecutionListenerExecution, Execution, PvmExecution, ProcessInstance, InterpretableExecution, PersistentObject, HasRevision {
  ...
  protected String presentTaskId;
...
public ExecutionEntity() {
  ...
  protected void initializeVariableInstanceBackPointer(VariableInstanceEntity variableInstance) {
    ...
    variableInstance.setTaskId(presentTaskId);
  }
  ...
  public String getPresentTaskId() {
	return presentTaskId;
  }

public void setPresentTaskId(String presentTaskId) {
	this.presentTaskId = presentTaskId;
}
...
public String getJumpActivityId() {
	return jumpActivityId;
}

public void setJumpActivityId(String jumpActivityId) {
