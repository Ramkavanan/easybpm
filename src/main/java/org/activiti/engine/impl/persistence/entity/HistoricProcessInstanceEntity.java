...
public class HistoricProcessInstanceEntity extends HistoricScopeInstanceEntity implements HistoricProcessInstance {
  ...
  protected String startNodeAssignee;
...
public HistoricProcessInstanceEntity() {
  ...
  public HistoricProcessInstanceEntity(ExecutionEntity processInstance,boolean isDraft) {
  ...
  public void setIsDraft(boolean isDraft) {
	...
	public String getStartNodeAssignee() {
		return startNodeAssignee;
	}

	public void setStartNodeAssignee(String startNodeAssignee) {
		this.startNodeAssignee = startNodeAssignee;
	}
}
