...
public class DeploymentManager {
  ...
  public ProcessDefinitionEntity findDeployedProcessDefinitionById(String processDefinitionId) {
    if (processDefinitionId == null) {
      throw new ActivitiException("No process definition id found");
    }
  ...
  public ProcessDefinitionEntity resolveProcessDefinition(ProcessDefinitionEntity processDefinition) {
    ...
    String classfication = processDefinition.getClassificationId();
    ...
    processDefinition.setClassificationId(classfication);
    return processDefinition;
  }
  ...
  public void removeDefinitionFromCache(String processDefinitionId) {
	  // Remove any process definition from the cache	    
	      processDefinitionCache.remove(processDefinitionId);
  }
  
  /**
   * Removes all the process definitions from cache
   * @param processDefinitions list of definitions
   * @author madan
   */
  public void removeDefinitionsFromCache(List<ProcessDefinition>processDefinitions) {
	  // Remove all process definitions from the cache	
	  for (ProcessDefinition processDefinition : processDefinitions) {
		  removeDefinitionFromCache(processDefinition.getId());
	}	      
  }
