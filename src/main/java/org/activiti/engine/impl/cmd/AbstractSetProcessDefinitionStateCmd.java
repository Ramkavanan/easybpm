...
public abstract class AbstractSetProcessDefinitionStateCmd implements Command<Void> {
  ...
  protected List<String> processDefinitionsIds = null;
  ...
  public AbstractSetProcessDefinitionStateCmd(boolean includeProcessInstances, Date executionDate,List<String> processDefinitionIds) {
	  this.includeProcessInstances = includeProcessInstances;
	  this.executionDate = executionDate;
	  this.processDefinitionsIds = processDefinitionIds;
  }
  ...
  protected List<ProcessDefinitionEntity> findProcessDefinition(CommandContext commandContext) {
    ...
    if(processDefinitionId == null && processDefinitionKey == null && processDefinitionsIds == null) {
    ...
    if(processDefinitionsIds != null){
    	List<ProcessDefinitionEntity> processDefinitionEntity = processDefinitionManager.findProcessDefinitionListByIds(processDefinitionsIds);
        if(processDefinitionEntity == null) {
          throw new ActivitiException("Cannot find process definition for List of ids '"+processDefinitionsIds+"'");
        }
        processDefinitionEntities.addAll(processDefinitionEntity);
