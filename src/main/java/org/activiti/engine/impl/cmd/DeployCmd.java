...
public class DeployCmd<T> implements Command<Deployment>, Serializable {
  ...
  public Deployment execute(CommandContext commandContext) {
    ...
    deployment.setClassificationId(deploymentBuilder.getClassificationId());
    deployment.setModifiedUser(deploymentBuilder.getModifieduser());
    deployment.setIsSystemDefined(deploymentBuilder.isSystemDefined());
