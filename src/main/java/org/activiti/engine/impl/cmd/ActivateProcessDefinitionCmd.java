...
public class ActivateProcessDefinitionCmd extends AbstractSetProcessDefinitionStateCmd {
  ...
  public ActivateProcessDefinitionCmd(boolean includeProcessInstances, Date executionDate,List<String> processDefinitionIds) {
    super(includeProcessInstances, executionDate,processDefinitionIds);
  }
