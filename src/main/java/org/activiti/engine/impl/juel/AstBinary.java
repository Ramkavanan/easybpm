...
public class AstBinary extends AstRightValue {
	...
	public static final Operator contains = new SimpleOperator() {
		@Override public Object apply(TypeConverter converter, Object o1, Object o2) { return BooleanOperations.contains(converter, o1, o2); }
