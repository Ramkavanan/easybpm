...
public class HistoryServiceImpl extends ServiceImpl implements HistoryService {
  ...
  public List<Map<String, Object>> createHistoicProcessDescribeQuery(List<HistoricProcessInstance> historicProcessInstance) throws BpmException{
	return commandExecutor.execute(new DescribeEntityCmd(historicProcessInstance));
  }
  
  public List<Map<String, Object>> createHistoricTaskDescribeQuery(List<HistoricTaskInstance> historicTaskInstance) throws BpmException{
	return commandExecutor.execute(new DescribeEntityCmd(historicTaskInstance));
  }
}
