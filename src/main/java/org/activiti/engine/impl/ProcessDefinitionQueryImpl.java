...
public class ProcessDefinitionQueryImpl extends AbstractQuery<ProcessDefinitionQuery, ProcessDefinition> 
  ...
  public ProcessDefinitionQuery activeVersion() {
	    this.isActiveVersion = true;    
	    return this;
	 }
  
  public ProcessDefinitionQuery modules(List<Module>modules) {
	    if(modules!=null&&modules.size()>0){
	    	this.modules = modules;    
	 	    return this;
	    }else{
	    	throw new EazyBpmException("No modules provided to search processes");
	    }	   
	 }
