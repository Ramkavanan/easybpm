...
import com.eazytec.bpm.engine.TaskRole;
 ...
 public interface OperatingFunction {
	...
	static final String CONFLUENT_SIGNATURE="collaborativeoperation";
	static final String CIRCULATE_PERUSAL="circulateperusal";
	static final String JUMP="jump";
	static final String TRANSACTOR_REPLACEMENT="transactorreplacement";
