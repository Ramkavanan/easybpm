...
public interface RuntimeService {
  ...
  /**
   * Get historic variable List for task
   * @param taskId
   * @param processInsId
   * @return
   */
  List<Map<String, Object>> getVariablesByTaskId(String taskId,String processInsId);
  ...
  /** Terminate an existing runtime process instance.
   * @param processInstanceId id of process instance to terminate, cannot be null.
   * @throws ActivitiException when no process instance is found with the given id.
   */
  ...
  /**
   * Gets all the historic variables belonging to task ids that are older than given task id
   * @param processInstanceId cannot be null
   * @param currentTaskId task referring this all the previous variables will be retrieved.
   * @return
   * @throws BpmException
   * 
   * @author madan
   */
  List<HistoricVariableInstance> getPrevHistoricVariableInstances(String processInstanceId, String currentTaskId) throws BpmException;
  
  /**
   * Gets all the historic variables belonging to given process instance ids
   * @param processInstanceIds list if ids, cannot be null
   * @return
   * @throws ActivitiException
   * @throws BpmException
   * 
   * @author madan
   */
  List<HistoricVariableInstance> getHistoricVariableInstances(List<String> processInstanceIds)throws ActivitiException, BpmException;
  
  List<HistoricVariableInstance> getHistoricVariableInstancesByTaskId(String processInstanceId, String taskId);
  
  void addCandidateUser(String taskId, String userId);
  void addCandidateReader(String taskId, String userId);
  void addCreatorUser(String taskId, String userId);
  Object taskReturn(String taskId);
  Object taskReturn(String taskId,boolean needToDoReturn);
  List<IdentityLinkEntity> getIdentityLinkForTaskId(String taskId);
  void AddHistoricIdentityDetails(String proInsId,String userId,boolean isRead);
  void AddHistoricIdentityDetails(String taskId);
  void removeHistoricIdentityDetails(String taskId,String userId);
   ...
   * @author rajasekar
   */
  Object taskJump(String taskId,String activityId,boolean needOrganizer,String nodeType);
  
  void addProcessedUser(String taskId, String userId);
  
  Object getOrganizersForProcessStart(String processDefinitionId,Map<String, Object> formValues); 
  
  String getLastTaskAssignee(String processInstanceId,String taskDefinitionKey);
  
  void terminateExecutionsByInstanceIds(List<String> processInstanceIds,Date currentDate);
  
  Object submitTaskFormData(Map<String, Object> rtFormValues);
   ...
   */
  void deleteProcessInstanceOnly(String processInstanceId)throws ActivitiException;
  
  /**
   * Withdraw process instance by id
   * @param processInstanceId
   */
  void withdrawProcessInstanceById(String processInstanceId);
  
void createAttachmentOfTask(String attachmentType, String taskId, String processInstanceId, String attachmentName, String attachmentDescription, InputStream content, String url, int attachmentCount, String currentDate);
  
  List<AttachmentEntity> getAttachmentsOfTask(boolean isPrevious,String taskId, boolean isInsert,boolean isStartForm,String insId);
  
  AttachmentEntity getAttachmentEntity(String id);
  
  List<AttachmentEntity> getAttachmentAndInsertForTask(List<String> ids,String taskId, boolean isInsert);
  
  List<IdentityLinkEntity> getCreatorIdentityLinkForTaskId(String taskId);
  void deleteAttachmentByIds(List<String> attachmentIds);
  
  Object getHistoricProcessedUserLink(HistoricTaskInstance task);
  
  Object getHistoricTaskDefinition(HistoricTaskInstance task);
  
  List<AttachmentEntity> getAttachmentForTask(String taskId);
  
  void recallTask(String processInstanceId,String taskId);

  void deleteMultipleProcessInstance(List<String> processInstanceId,String deleteReason);
  
/**
 * update task entity
 * @param taskEntity
 */
  void updateTaskEntityCmd(TaskEntity taskEntity);

void updateHistoricTaskEntityCmd(TaskEntity taskEntity);
}