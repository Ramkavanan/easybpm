 ...
 *  @author mahesh
 */
CKEDITOR.plugins.add( 'datetimepicker', {
	init: function( editor ){
		...
		editor.ui.addButton( 'DateTimePicker', {
			...
			command: 'showDateTimePickerInDialog',
			icon: '/scripts/ckeditor/plugins/datetimepicker/images/datetime.png'
		});
						
		editor.addCommand( 'showDateTimePickerInDialog', new CKEDITOR.dialogCommand( 'datetimepicker' ) );
		...
		CKEDITOR.dialog.add( 'datetimepicker', function( editor )
				{
					...
					return {
						title : form.title.datetimepicker,
						minWidth : 350,
						minHeight : 150,
						onShow : function()
						{
						...
						onOk : function()
						{
							...
							if ( isInsertMode ){
								...
								var fakeElement = editor.createFakeElement( element, 'cke_datefield', 'datefield', true );
								...
								elements : [
									{
										type : 'html',
										align : 'left',
										html : '<span class="color-red">*</span><span class="form-title-msg">'+form.msg.datetimepicker+'</span>'
									}, 
									{
										id : '_cke_saved_name',
										type : 'text',
									...
									},
									{
										...
										[
											...
											},
											{
												...
												items :
												[
													[ form.msg.datePicker, 'datepicker' ],
													[ form.title.labelDateTimePicker, 'datetimepicker' ]
												],
											    onChange : function() {
												...
												setup : function( element ){
													...
													if(className.indexOf("datepicker") > -1){
														this.setValue('datepicker');
													}else if(className.indexOf("datetimepicker") > -1){
														this.setValue('datetimepicker');
													}else{
														this.setValue('');
													}
									...
									},
									{
										...
										[
											...
											},
											{
												...
												onLoad : function(){
													var element_id = '#' + this.getInputElement().$.id;
											    	getAllColumnByTableId(element_id, $("#tableId").val(), 'datepicker');
											    },
											    commit : function( element )
												{
											    	//var element = data.element;
