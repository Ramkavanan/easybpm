...
CKEDITOR.editorConfig = function( config ) {
	...
	//alert("==in=");
	//config.contentsCss = ['/styles/lib/bootstrap-2.2.1.min.css', '/styles/lib/bootstrap-responsive-2.2.1.css', '/styles/easybpm/basicLayout/reset.css', '/styles/easybpm/basicLayout/layout.css', '/scripts/ckeditor/contents.css', '/styles/easybpm/common/common.css', '/styles/easybpm/jqueryUI/jquery-ui-1.8.24.css','/styles/easybpm/basicLayout/text.css','/styles/easybpm/general/general.css'];
