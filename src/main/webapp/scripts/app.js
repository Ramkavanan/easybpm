		        	   ...
		        	   //var ajaxLoaderFrame = new ajaxLoader(document.getElementById('ajax_loader'));
						...
						document.getElementById('target_iframe').style.width = "99.5%";
				 		...
				 		//if (ajaxLoaderFrame) ajaxLoaderFrame.remove();
				 				...
				 				_mainContainer = "target";
				 				 ...
				 				 if(template.indexOf('<body id="login">') > -1){
					 				 ...
					 				 if(_mainContainer == 'target'){
					 					...
					 					//template = '<div class="row-fluid"><div class="span12"><ul class="breadcrumb"><li><a href="#">Home</a> <span class="divider">></span></li><li><a href="#">Library</a> <span class="divider">></span></li><li class="active">Data</li></ul></div></div>'+template;
					 				 }
				 		 ...
				 		 .done(function() {  })
				 		 .fail(function() { alert("Problem connecting server, check the status!"); });
				 	}
		           _params="";
    		},
