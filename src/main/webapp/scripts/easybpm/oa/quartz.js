	    	        	...
	    	        	$.ajax({
	    	        		...
	    	        		success : function(response) {
		    	        			...
		    	        			if(response.successMessage){
	        							...
	        							//timingTaskMessageDisplay(title,"Task(s) deleted successfully",type,viewId,viewName,tempResult);
		    	        			}else{
		    	        			//	validateMessageBox("Error", " Error in deleting task(s) ", "error");
	...
	if(container!= undefined){
		...
		$.ajax({
			...
			dataType: 'html',
				...
				failure: function(response){
					validateMessageBox("Error",form.error.homePageReport,"error");
				}
		});
	    	        		...
	    	        		success : function(response) {
	    	        			//alert(response);
		    	        			if(response.successMessage){
	        							...
	        							//alert("success ");
	        						//	timingTaskMessageDisplay(title,"QuickNavigation(s) deleted successfully",type,viewId,viewName,tempResult);
