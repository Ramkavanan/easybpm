...
(function ($) {
	...
	$(function() {
		...
		var u = navigator.userAgent.toLowerCase(),
			...
			css_string = '' + 
				'.jstree ul, .jstree li { display:block; margin:0 0 0 0; padding:3px; list-style-type:none;} ' + 
				'.jstree li { display:block; min-height:18px; line-height:18px; white-space:nowrap; margin-left:18px; min-width:18px; } ' + 
				'.jstree-rtl li { margin-left:0; margin-right:18px; } ' + 
				'.jstree > ul > li { margin-left:0px; } ' + 
				'.jstree-rtl > ul > li { margin-right:0px; } ' + 
				'.jstree ins { display:inline-block; text-decoration:none; width:18px; height:18px; margin:0 0 0 0; padding:0; } ' + 
				'.jstree a { display:inline-block; line-height:16px; height:16px; color:black; white-space:nowrap; text-decoration:none; padding:1px 2px; margin:0; font-size:14px;} ' + 
	...
	$.jstree.plugin("core", {
		...
		_fn : { 
			...
			clean_node	: function (obj) {
				...
				obj.not(".jstree-open, .jstree-closed").addClass("jstree-closed").children("ul").remove();
				this.__callback({ "obj" : obj });
			},
			// rollback
...
(function ($) {
	...
	$(function () {
		...
		$.vakata.context.cnt
			...
			.appendTo("body");
		$(document).bind("mousedown", function (e) { if($.vakata.context.vis && !$.contains($.vakata.context.cnt[0], e.target)) { 
			//$.vakata.context.hide();
			$($.vakata.context.cnt[0]).hide();
		} });
