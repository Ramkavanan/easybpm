...
<body<decorator:getProperty property="body.id" writeEntireProperty="true"/> class="eazybpmBody" id="default_body">
	<div class="container-fluid">
		<div class="main-container">
			<div class="row-fluid">
				<div class="span12">
						<b>&nbsp&nbsp&nbsp&nbsp 	Process Name : ${processName}<br />
						   &nbsp&nbsp&nbsp&nbsp Task Name 	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp   : ${activeTask} </b>
					...
					<div id="processFormDesignValues" class="padding10">
						...
						<input type="hidden" name="type" id="gridType" value='${gridType}'/>
					  	...
					  	<%--<div id="task-form" class="hide"><%= request.getAttribute("taskFormScript") %></div>  
						 <div class="widget">
							<div class="widget-body">
								<div id="wizard">
									<ol>
										<li>Form Values</li>
										<li>Input Opinion</li>
										<li>Instance Trace</li>
									</ol>
									<div class="well">
										<div class="row-fluid">
											<div id="taskFormDiv" class="pull-left" style="position:relative;">
											</div>
											<div id="operatingFunctionDiv" class="pull-right">
							...
							<div id="formWizardTab-content-3" class="displayNone">
								<div id= "WorkFlowTraceDetail">
									<div class="row-fluid">
										...
										<div id ="workflowTraceTableDiv">	
											<div style="line-height: 33px; font-weight: bold;">Process Input Trace :</div>
											<table id="workflowTraceTable" class="table table-condensed table-bordered no-margin">
												<tr>
													<th>No</th>
													<th>Node Name</th>
						...
						<div id="formWizardTab-content-3" class="displayNone">
							<div id= "WorkFlowTraceDetail">
								<div class="span10" id="opinion_div">
									<div class="height25"></div>
									<%=request.getAttribute("workFlowTrace")%>
									<div id ="workflowTraceTableDiv">	
									<b>Process Input Trace :</b>
										<table id="workflowTraceTable" class="table_with_border">
											<tr class="table_with_border"  bgcolor="#CECECE">
												<th class="table_with_border" >No</th>
												<th class="table_with_border" >Node Name</th>
												<th class="table_with_border" >Organiser</th>
												<th class="table_with_border" >Operation Time</th>
												<th class="table_with_border" >Operate Type</th>	
												<th class="table_with_border" >Process Name</th>	
											</tr>
										</table> </div>
									<div>&nbsp;</div>
									<div>&nbsp;</div>
									<div id ="formFieldTraceTableDiv"></div>
										<table class="table_with_border" id="formFieldTraceTable">
											 <tr bgcolor="#CECECE">
											</tr>  --%>
										</table> 
									</div>
	...
	function addRowForFormFiledAudit(tableID,values,no) {
	    var table = document.getElementById(tableID);
		if(no == 1){
			document.getElementById("formFieldTraceTableDiv").innerHTML = "<div style='line-height: 33px; font-weight: bold;'>Form Field Audit :</div>";
