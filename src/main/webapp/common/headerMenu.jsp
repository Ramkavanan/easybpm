<ul class="hidden-phone">
	...
	<li class="dropdown">
		<a title="Settings" data-toggle="dropdown" class="dropdown-toggle" href=""> <span class="fs1" aria-hidden="true" data-icon="&#xe090;"></span> </a>
		<ul class="dropdown-menu pull-right">
			<li><a href="#bpm/admin/getChangePassword" onClick="setBreadCrumb('Preferences', '', '','/admin/getChangePassword','root','');_execute('target', '');" id="changePassword">Preferences</a></li>
			<li><a href="#bpm/admin/userform" onClick="setBreadCrumb('Profile', '', '','/admin/userform','root','');_execute('target', 'from=profile');" id="profile">Profile</a></li>
			
		</ul>
	</li>
	<li>
		<a title="LogOut" href="logout" onClick="clearMenuDataFromCookie();window.top.logOut();" ><span class="fs1" aria-hidden="true" data-icon="&#xe0b1;"></span></a>
	</li>
</ul>
