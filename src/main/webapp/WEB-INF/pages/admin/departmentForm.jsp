...
<script type="text/javascript">
	...
	$(document).ready(
			function() {
				...
				setUserFullNames("administratorsFullName", $('#administrators')
						.val(), JSONUsers);
				setUserFullNames("interfacePeopleFullName", $(
						'#interfacePeople').val(), JSONUsers);
				setUserFullNames("departmentOwnerFullName", $(
						'#departmentOwner').val(), JSONUsers);
			});
</script>
...
<div align="right">
	<a class="padding10" style="text-decoration: underline;"
		...
		data-theme="b" onClick="backToPreviousPage()" data-icon=""><button class="btn"><strong><fmt:message
				key="button.back" /></strong></button></a>
</div>
			...
			<div class="box_main" style="padding-top: 10px">
				<form:form id="department" commandName="department" method="post"
					...
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="superDepartment" id="superDepartment"
