...
<div class="container-fluid form-background">
	...
	<div class="row-fluid">
		 <c:if test="${selection=='user'}">
		 	<div align="right"><input type="text" id="searchUserName" class="small" name="searchUserName" autocomplete="off" onkeyup="getUserNameAndPosition(event,'${selectionType}','${appendTo}','${currentUser}');" onclick="getUserNameAndPosition(event,'${selectionType}','${appendTo}','${currentUser}');" onchange="selectUserAndPosition('${selectionType}','${appendTo}');" placeholder="Search User" list="searchUserNameWithPosition"/>
		 		<datalist id="searchUserNameWithPosition">
		 	</div>
		 </c:if>
		 <c:if test="${selection=='selectedListView'}">
		 	<div align="right"><input type="text" id="searchListViewName" class="small" name="searchListViewName" autocomplete="off" onkeyup="getListViewName(event,'${selectionType}','${appendTo}','${currentUser}');" onclick="getListViewName(event,'${selectionType}','${appendTo}','${currentUser}');"  onchange="selectListViewName('${selectionType}','${appendTo}');" placeholder="Search List View" list="searchListViewNameList"/>
		 		<datalist id="searchListViewNameList">
		 	</div>
		 </c:if>
		<c:if test="${selection=='process'}">
		 	<div align="right"><input type="text" id="searchProcessName" class="small" name="searchProcessName" autocomplete="off" onkeyup="getProcessName(event,'${selectionType}','${appendTo}','${currentUser}');" onclick="getProcessName(event,'${selectionType}','${appendTo}','${currentUser}');"  onchange="selectProcessName('${selectionType}','${appendTo}');" placeholder="Search Process" list="searchProcessNameList"/>
