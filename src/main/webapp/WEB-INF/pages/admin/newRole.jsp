...
<div align="right"><a class="padding10" style="text-decoration: underline;" id="backToPreviousPage" href="javascript:void(0);" data-role="button" data-theme="b"  onClick="backToPreviousPage()" data-icon=""><button class="btn"><strong><fmt:message key="button.back"/></strong></button></a> </div>
</div>
	<div class="span12">
	<div class="row-fluid">
				<div class="widget-body">
					...
					<form:form  id="role" commandName="role" method="post" class="form-horizontal no-margin" action="bpm/admin/saveRole" autocomplete="off" modelAttribute="role" onSubmit="_execute('target','')">
						...
						<div class="control-group" id="deptdiv">
							...
							<div class="controls">
								<form:input path="roleDepartment" id="roleDepartment" class="span6 white-background" onclick="showDepartmentSelection('Department', 'single' , 'roleDepartment', this, '',true);" readonly="true"/>
							</div>
						</div>
