...
<%-- <form:form commandName="listView" name="listView" method="post" action="bpm/listView/saveListView" id="listView" autocomplete="off" 
		   cssClass="form-horizontal" enctype="multipart/form-data">
    <form:hidden path="id"/> 
	<fieldset>
		<div id="collapse-personal" class="accordion-body">
			<table width="82%" class="basic_property_table">
			<tr height="13px"></tr>
	            <tr class="displayNone" id="list_view_template_row">									
					<td>
						<fieldset class="control-group">
				            <eazytec:label styleClass="control-label style3 style18 " key="listView.template"/>
				            <div class="controls">
					            <select class="large" id="list_view_template" onChange="showListViewTemplateData(this.value);"></select>
				            </div>
			        	</fieldset>
					</td>
				</tr>
				<tr>									
			 	...
			 	<tr class="show_list_view_module">
					<td>
						<fieldset class="control-group">
				            <eazytec:label styleClass="control-label style3 style18 " key="listView.module"/>
				            <div class="controls">
					                <input type="text" autocomplete="off" list="searchModuleresults" value="${moduleName}" id="module" class="large" name="_showmoduleName" onblur="setFormModuleDetailsByFieldName('module_Id','false','_showmoduleName','true')">
				...
				<tr>
					<td>
						<fieldset class="control-group">
				            ...
				            <div class="controls">
					                <form:input path="pageSize" id="pageSize" class="large" value=""/><!-- value="15" -->
				            </div>
			        	</fieldset>
					</td>
				</tr>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                               ...
                               <div class="controls"> <span style="padding-top: 5px;"><form:checkbox id="isNeedCheckbox" path="isNeedCheckbox"/></span></div>
                                </fieldset>
                           </td>
                        </tr>
                    </table>
                ...
                <tr>
                    ...
                    <table>
                        <tr>
                            <td>
                                <fieldset class="control-group">
                                    <eazytec:label styleClass="control-label style3 style18 " key="listView.isTemplate"/>
                                     <div class="controls">
                            ...
                            <td>
                                <fieldset class="control-group">
                                    ...
                                    <div class="controls"><span style="padding-top: 5px;"> <form:checkbox id="isFilterDuplicateData" path="isFilterDuplicateData"/></span></div>
				...
				<tr>
					<td>
						<fieldset class="control-group">
<!-- 				            <eazytec:label styleClass="control-label style3 style18 " key="listView.isShow"/> -->
<!-- 				             <div class="controls"> -->
		            		<form:hidden id="isShow" path="isShow" value='true'/>
<!-- 		            		</div> -->
				    	</fieldset>
			        </td>
				</tr>
				<tr>
					<td>
						<fieldset class="control-group">
				            ...
				            <div class="controls">
					            <form:textarea path="fromQuery" id="fromQuery" rows="3" cols="45" style="width:86%" onclick="disableSaveButton();" />
				...
				<tr>
					<td>
						<fieldset class="control-group">
				            ...
				            <div class="controls">
					            <form:textarea path="selectColumns" id="selectColumns" rows="3" cols="45" style="width:86%" onclick="disableSaveButton();"/>
				...
				<tr>
					<td>
						<fieldset class="control-group">
				            <eazytec:label styleClass="control-label style3 style18 " key="listView.filterDuplicateDataColumn"/>
				            <div class="controls">
				            		 <select class="large" id="list_view_filter_duplicate" onfocus="listViewFillFilterColumn();"></select>
				            </div>
			        	</fieldset>
					</td>
				</tr>
				<tr>
					<td>
						<fieldset class="control-group">
				            ...
				            <div class="controls">
					            <form:textarea path="whereQuery" id="whereQuery" rows="3" cols="45" style="width:86%" onclick="disableSaveButton();"/>
				            </div>
			        	</fieldset>
					</td>
				</tr>
				<tr>
					<td>
						<fieldset class="control-group">
				            ...
				            <div class="controls">
					            <form:textarea path="orderBy" id="orderBy" rows="2" cols="45" style="width:86%" onclick="disableSaveButton();"/>
				            </div>
			        	</fieldset>
					</td>
				</tr>
				<tr>
					<td>
						<fieldset class="control-group">
				            ...
				            <div class="controls">
					            <form:textarea path="groupBy" id="groupBy" rows="2" cols="45" style="width:86%" onclick="disableSaveButton();"/>
				            </div>
			        	</fieldset>
					</td>
				</tr>
				<tr>
					<td>
						<fieldset class="control-group">
				            <eazytec:label styleClass="control-label style3 style18 " key="list.view.label.onRenderScriptName"/>
				            <div class="controls">
					             <form:input path="onRenderScriptName" id="onRenderScriptName" class="large"/>
				            </div>
			        	</fieldset>
					</td>
				</tr>
				<tr>
					<td>
						<fieldset class="control-group">
				             <eazytec:label styleClass="control-label style3 style18 " key="list.view.label.onRenderScript"/>
				            <div class="controls">
					            <form:textarea path="onRenderScript" id="onRenderScript" rows="4" cols="45" style="width:86%"/>
				            </div>
			        	</fieldset>
					</td>
				</tr>
		...
		<div class="cont">
			<div class="button" id="saveButtonDiv">
	            ...
	            <c:when test="${isEdit=='true'}" >
		            	<button type="button" onClick="_checkListViewQuery();" class="btn btn-primary checkQueryButton padding0 line-height0">
				     	<fmt:message key="listview.button.checkListViewQuery"/>
			         </button>
					 <button type="submit" class="btn btn-primary normalButton padding0 line-height0" name="save" id="saveButton" onClick="checkIsTemplateSelected();appendFilterColumnInGroupByField();">
		        		<c:choose>
							<c:when test="${not empty listView.id && isListViewTemplate == false}">
