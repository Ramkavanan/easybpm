...
<%-- <div class="container-fluid" id="parent_container">
	<div class="row-fluid">
	    <div id="group_setting_prop_form" class="span12" style="overflow-y:auto;border:1px solid #B6B6B6;">
	    	<table width="100%" id="multi_fields">
	    		<input type="hidden" id="columnPropertyIdInGS" name="columnPropertyIdInGS" />
	    		<tr class="row-height"></tr>
				<tr>						
					<td class="pad-L10">
				    	<eazytec:label styleClass="control-label style3 style18 " key="list.view.groupSetting.groupName"/>
					</td>
					<td>						
			            <div class="controls">
				           	<input type="text" class="large" id="groupName" name="groupName" />
			            </div>
					</td>
					<td class="pad-L10">
			            <eazytec:label styleClass="control-label style3 style18 " key="list.view.groupSetting.groupFieldsName"/>
					</td>
					<td>						
			            <div class="controls">
				           	<select class="large"  id="groupFieldsName" name="groupFieldsName" >
				           	</select>
			            </div>
					</td>
				</tr>
				...
				<tr>
					<td class="pad-L10" >
				    	<eazytec:label styleClass="control-label style3 style18 " key="list.view.groupSetting.groupType"/>
					</td>
					<td align="left">						
			            <div class="controls">
		           				<input type="radio" id="groupTypeMulti" name="groupType" value="Multi" checked="true"/> 
		           				<fmt:message key="list.view.groupSetting.groupTypeMulti"/> &nbsp;&nbsp;&nbsp;
		           				<input type="radio" id="groupTypeSingle" name="groupType" value="Single"/> 
				           	 	<fmt:message key="list.view.groupSetting.groupTypeSingle"/> 
			            </div>
					</td>
					<td class="pad-L10">
			            <eazytec:label styleClass="control-label style3 style18 " key="list.view.groupSetting.parentGroup"/>
					</td>
					<td>						
			            <div class="controls">
				           	<select class="large" id="parentGroup" name="parentGroup"/>
			            </div>
					</td>
				</tr>
				<tr class="row-height"></tr>
				<tr>
					<td class="pad-L10">
			            <eazytec:label styleClass="control-label style3 style18 " key="list.view.groupSetting.sortType"/>
					</td>
					<td>						
			            <div class="controls">
            				<input type="radio" id="sortTypeAsc" name="sortType" value="Asc" checked="true"/> 
			           	 	<fmt:message key="list.view.groupSetting.sortTypeAsc"/> &nbsp;&nbsp;&nbsp;
	           				<input type="radio" id="sortTypeDesc" name="sortType" value="Desc"/> 
	           				<fmt:message key="list.view.groupSetting.sortTypeDesc"/>
			            </div>
					</td>
					<td class="pad-L10">
			            <eazytec:label styleClass="control-label style3 style18 " key="list.view.groupSetting.orderBy" />
					</td>
					<td>						
			            <div class="controls">
				           	<input type="text" class="large" id="groupOrder" name="groupOrder" value="0"/>
			            </div>
					</td>
				</tr>
				<tr class="row-height"></tr>
				<tr>
					<td class="pad-L10">
			            <eazytec:label styleClass="control-label style3 style18 " key="list.view.groupSetting.comment" />
					</td>
					<td>						
			            <div class="controls">
				           	<textarea class="large" id="groupSettingcomment" name="groupSettingcomment" />
			            </div>
					</td>
					<td colspan="2" align="right" class="pad-R25">
						<button type="button" onClick="_addGroupSettingRecord();" class="btn btn-primary normalButton padding0 line-height0">
			         		<fmt:message key="button.add"/>
			         	</button>
			         	<button type="button" onClick="_clearGroupSettingRecord();" class="btn btn-primary normalButton padding0 line-height0">
	...
	<div class="row-fluid">
	    <div id="group_setting_prop_grid" class="span12" style="border:1px solid #B6B6B6;">
	    	<div id="group_setting_property_grid" >
				...
				<table width="100%">
					...
					<tr>
						<td align="center">
				         	<button type="button" onClick="_saveOrUpdateAllGroupSettingRecord('${listView.id}');" class="btn btn-primary normalButton padding0 line-height0" >
								<fmt:message key="button.save"/>
				    		</button>
				         	<button type="button" onClick="_deleteGroupSettingRecord();" class="btn btn-primary normalButton padding0 line-height0">
				         		<fmt:message key="button.delete"/>
				         	</button>
				         	<button type="button" onClick="_deleteGroupSettingAllRecord();" class="btn btn-primary normalButton padding0 line-height0">
