...
<div class="page-header">
	...
	<div align="right">
		<strong><a id="backToPreviousPage" style="text-decoration: underline;padding: 10px;" href="javascript:void(0);" data-role="button" data-theme="b" onClick="backToPreviousPage()" data-icon=""><fmt:message key="button.back" /></a> </strong>
	</div>
...
<div class="row-fluid">
	<div class="span12">
		<form:form commandName="user" method="post" action="bpm/admin/userform" id="userForm" autocomplete="off" enctype="multipart/form-data" onSubmit="_execute('target','')">
				<form:hidden path="whereTheWork" />
			  <form:hidden path="resposibilities" />
 			  <form:hidden path="comment" />			
			<div class="widget">
				<div class="widget-body">
					<div id="wizard">
						<ol>
							<li><fmt:message key="userProfile.personalDetails" /></li>
							<li><fmt:message key="userProfile.jobDetails" /></li>
							<li><fmt:message key="userProfile.contactDetails" /></li>
							<li><fmt:message key="userProfile.permissions" /></li>
							<li><fmt:message key="userProfile.others" /></li>
						</ol>
...
<!-- 								</div> -->
							...
							<div class="form-horizontal no-margin">
								<div class="control-group">
									...
									<%--	<form:input path="employeeNumber" id="employeeNumber"
											...
											<span id="employeeNumber" class="control-label" style="text-align:left;">${user.employeeNumber}</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<span id="idCardNumber" class="control-label" style="text-align:left;">${user.idCardNumber}</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<span id="position" class="control-label" style="text-align:left;">${user.position}</span>
								...
								<div class="control-group">
									...
									<div class="controls">
										<%--<form:input path="partTimePosition" id="partTimePosition" maxlength="50"
										 class="span6" />--%>
										 <span id="partTimePosition" class="control-label" style="text-align:left;">${user.partTimePosition}</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<span id="managerFullName" class="control-label" style="text-align:left;"></span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<span id="secretaryFullName" class="control-label" style="text-align:left;"></span>	
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<%--<form:input path="department" id="department" class="span6  white-background" onclick="showDepartmentSelection('Department', 'single' , 'department', this, '','true');" readonly="true"/>--%>
										
										<span id="department" class="control-label" style="text-align:left;">${user.department}</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<!--<form:input path="partTimeDepartment" id="partTimeDepartment" class="span6  white-background" onclick="showDepartmentSelection('Department', 'single' , 'partTimeDepartment', this, '','true');" readonly="true" />-->
										<span id="partTimeDepartment" class="control-label" style="text-align:left;">${user.partTimeDepartment}</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div id="contact">
							<div class="form-horizontal no-margin">
								...
								<div class="control-group">
									<eazytec:label styleClass="control-label" key="user.address.country" />
									<div class="controls">
										<eazytec:country name="address.country" prompt="" default="${user.address.country}" />
									</div>
								</div>
							</div>
						</div>
						...
						<div id="permission">
							<div class="form-horizontal no-margin">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input style="display:none;" type="text" id="userRoles" name="userRoles" class="span6 white-background" onclick="showRoleSelection('Role', 'multi' , 'userRoles', this, '','true');" readonly="readonly" />
										<span id="userRoles" class="control-label" style="text-align:left;">${userRoles}</span>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input style="display:none;" type="text" id="userGroups" name="userGroups" class="span6 white-background" onclick="showGroupSelection('Group', 'multi' , 'userGroups', this, '');" readonly="readonly" />
										<span id="userGroups" class="control-label" style="text-align:left;">${userGroups}</span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="form-horizontal no-margin">
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<span id="whereTheWork" class="control-label" style="text-align:left;">${whereTheWork}</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<span id="comment" class="control-label" style="text-align:left;">${comment}</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<span id="resposibilities" class="control-label" style="text-align:left;">${resposibilities}</span>
									</div>
								</div>
							</div>
							</div>
					...
					<div class="control-group" align="center">
						<div class="form-actions no-margin">	
							<span id="saveButtonDiv" align="center">
								<button type="submit" name="save" onclick="bCancel=false;" class="btn btn-primary" id="saveButton" class="cursor_pointer">
									<c:choose>
							...
							<span id="cancelButtonDiv" class="">
								<button type="button" class="btn btn-primary" name="cancel" onclick="backToPreviousPage()" id="cancelButton" class="cursor_pointer">
