...
<div class="page-header">
	...
	<div align="right">
		<strong><a id="backToPreviousPage" style="text-decoration: underline;padding: 10px;" href="javascript:void(0);" data-role="button" data-theme="b" onClick="backToPreviousPage()" data-icon=""><button class="btn"><fmt:message key="button.back" /></button></a> </strong>
	</div>
						...
						<!-- <div id="permission"> -->
							<div class="form-horizontal no-margin" id="permission">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="userRoles" name="userRoles" class="span6 white-background" onclick="showRoleSelection('Role', 'multi' , 'userRoles', this, '','true');" readonly="readonly" />
									</div>
								</div>
								<div class="control-group">
									<eazytec:label styleClass="control-label " key="userProfile.assignGroups" />
									<div class="controls">
										<input type="text" id="userGroups" name="userGroups" class="span6 white-background" onclick="showGroupSelection('Group', 'multi' , 'userGroups', this, '');" readonly="readonly" />
									</div>
								</div>
							</div>
						<!-- </div> -->
