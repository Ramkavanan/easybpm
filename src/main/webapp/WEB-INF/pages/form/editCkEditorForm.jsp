...
<script><!--
    $(document).ready(function(){
    	...
    	//$("#ckEditor").css('height',parseInt(height)-100);
    	...
    	$("#button_panel button").each(function() {
    		$(this).click(function() {
    		    ...
    		    if(tabId[1] == 1){
					...
					var height = $("#target").height();
					document.getElementById("paletteList").style.height = height-60+"px";
	 			 	if(_prev_tab_id == 3){
	 			 		if(htmlSourceBeforePreview!=''){
	 			 			window.setTimeout(function(){CKEDITOR.instances.editor1.setData(htmlSourceBeforePreview);},0);
	 			 		}
	 			 	}else if(_prev_tab_id == 2 || _prev_tab_id == 4){
	 			 		htmlSourceBeforePreview = $("#htmlsource").text();
	 			 		window.setTimeout(function(){CKEDITOR.instances.editor1.setData(htmlSourceBeforePreview);},0);
	 			 	}
	 			 	CKEDITOR.instances['editor1'].destroy();
					renderCKEditor();
	 			 	window.setTimeout(function(){CKEDITOR.instances.editor1.setData( htmlSourceBeforePreview, function() {
	 			 		_prev_tab_id = 1;
						CKEDITOR.instances.editor1.focus();
						if(htmlSourceBeforePreview.indexOf("changeWizardByTabForDynamicForm()") > -1){
		 		  ...
		 		  if(tabId[1] == 3){
		 			 if(_prev_tab_id != 3){
						...
						document.getElementById("paletteMainContainer").style.width="96%";
						document.getElementById("paletteList").style.display="none";
						var htmlsourceHeight = parseInt(CKEDITOR.instances.editor1.getData().length);
						$("#preview_form").css('height',htmlsourceHeight);
		 		 ...
		 		 if(tabId[1] == 4){
		 			var htmlSourceBeforePreview= $("#htmlSourceBeforePreview").html();
		 			 if(_prev_tab_id==3 && htmlSourceBeforePreview!=''){
		 				window.setTimeout(function(){CKEDITOR.instances.editor1.setData(htmlSourceBeforePreview);$("#htmlsource").html(htmlSourceBeforePreview);},0);
		       		 }
		 			 ...
		 			 if(_prev_tab_id != 3){
						...
						document.getElementById("paletteMainContainer").style.width="96%";
						document.getElementById("paletteList").style.display="none";
						//document.getElementById("hiddedPalette").style.display = "";
						$("#print_preview_form").css('height',parseInt(height)-185);
...
<div class="row-fluid">
	<div class="page-header">
		<div class="pull-left">
			<h2><fmt:message key="form.edit.title"/></h2>
		</div>
		<span class="floatRight fontSize14 pad-L10 pad-T2">
   		...
   		<div id="button_panel" class="pull-right">
   			...
   			<button class="btn hidden-tablet" id="tabs-4" type="button"><fmt:message key="form.print.preview"/></button>
<!--    			<ul id="tabs"> -->
<%--    				<li id="tabs-1" class="btn btn-primary"><fmt:message key="form.design"/></li> --%>
<%--    				<li id="tabs-2" class="btn hidden-tablet"><fmt:message key="form.hTMLSource"/></li --%>
<%--    				><li id="tabs-3" class="btn hidden-tablet"><fmt:message key="form.preview"/></li> --%>
<!--    			</ul> -->
   		</div>
	</div>
<!--	<div class="row-fluid background-white" style="border-left:1px solid #999999;"> -->
<!-- 				<div class="span12"> -->
<!-- 					<div class="titleBG"> -->
<%-- 			     		<span class="floatLeft fontSize14 pad-L10 pad-T10"><fmt:message key="form.edit.title"/> - ${metaForm.formName}</span>			 --%>
<!-- 			     		<span class="floatRight fontSize14 pad-L10 pad-T2"> -->
<!-- 			     		<div style="cursor: pointer;"> -->
<!-- 			     				<img onclick="goBackToFormListView();" src="/images/arrow-left.png" /> -->
<!-- 			     			</div> -->
...
<!-- 			     			<ul id="tabs"> -->
<!-- 			     				<li id="tabs-1" class="selected"> -->
<%-- 			     					<fmt:message key="form.design"/> --%>
<!-- 			     				</li> -->
<!-- 			     				<li id="tabs-2"> -->
<%-- 			     					<fmt:message key="form.hTMLSource"/> --%>
<!-- 			     				</li> -->
<!-- 			     				<li id="tabs-3"> -->
<%-- 			     					<fmt:message key="form.preview"/> --%>
<!-- 			     				</li> -->
<!-- 			     				<li id="tabs-4"> -->
<%-- 			     					<fmt:message key="form.print.preview"/> --%>
<!-- 			     				</li> -->
<!-- 			     			</ul> -->
<!-- 			     		</div> -->
<!-- 					</div> -->
...
<!-- 			</div> -->
	<div class="span12">
		<div class="span2" id="paletteList">
			<div class="widget">
		...
		<!--    				<li> -->
		<%--    					<a class="menuitem1 pad-B8"><span class="style7"><span class="style9"><fmt:message key="form.palette"/></span></img></span> <img src="/images/easybpm/common/palette_icon.png" class="floatRight"/></a> --%>
		<!--    				</li> -->
		<!--    			</ul> -->
		<%-- 			<ul class="tabBackground mar-B5 height20"><span class="style9 pad-L10"><fmt:message key="form.palette.controls"/></span></ul> --%>
						<a class="form_elements btn btn-small btn-block"  id="textfield" href="#" > 
							<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/textbox.png" /></div>
					...
					<a class="form_elements btn btn-small btn-block"  id="label" href="#" > 
							<div align="left">
							<div class="floatLeft" style="padding-right:2px;margin-top:-3px;" ><img src="/images/easybpm/form/label.png" /></div>
							<span class="fs1" aria-hidden="true">Label</span> 
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block"  id="numberfield" href="#" > 
							<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/number.png" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block"  id="textarea" href="#" > 
			        		<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/textarea.png" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block"  id="select" href="#" > 
							<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/dropdown.png" /></div> 
			        	 ...
			        	 <a class="form_elements btn btn-small btn-block"  id="autocomplete" href="#" > 
							<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/autocompletefield.png" /></div>
			        	...
			        	<a class="form_elements btn btn-small btn-block"  id="radio" href="#" > 
							<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/radiobutton.png" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block"  id="checkbox" href="#" > 
							<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/checkbox.png" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block"  id="hiddenfield" href="#" > 
							<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/hiddenfield.gif" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block" id="datetimepicker" href="#"> 
			        		<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/datetime.png" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block" id="button" href="#"> 
			        		<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/submitbutton.png" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block" id="showbuttons" href="#"> 
			        		<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/button_list.png" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block" id="fileupload" href="#"> 
			        		<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/fileupload.png" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block" id="image" href="#"> 
			        		<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/imageIcon.png" /></div> 
			            ...
			            <a class="form_elements btn btn-small btn-block" id="usercontrol" href="#"> 
			                   <div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/usercontrol.png" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block" id="userlist" href="#"> 
			        		<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/user_icon.png" width="14" height="14"/></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block" id="departmentlist" href="#"> 
			        		<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/departments.png" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block" id="rolelist" href="#"> 
			        		<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/role_icon.png" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block" id="grouplist" href="#"> 
			        		<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/group_icon.png" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block" id="subforms"href="#"> 
			        		<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/subformm.png" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block" id="templates" href="#"> 
			        		<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/template.png" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block" id="richtextbox" href="#"> 
			        		<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/richtextbox.jpg" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block" id="gridviewcontrol" href="#"> 
			        		<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/gridview.jpg" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block" id="tabcontrol" href="#"> 
			        		<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/scripts/ckeditor/plugins/tabcontrol/images/tab-add-icon.png" /></div> 
			        	...
			        	<a class="form_elements btn btn-small btn-block" id="onloadevent" href="#"> 
			        		<div align="left">
								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/scripts/ckeditor/plugins/onloadevent/images/onload.gif" /></div> 
			...
			<ul class="section1 menu listStyle-none">
			  ...
			  <a class="menuitem1"></span> <img src="/images/easybpm/common/palette_hide_icon.png"/></a>
			      <ul class="submenu listStyle-none">
			        ...
			        <li><a><div class="pad-T3"> <img src="/images/easybpm/form/number.png" /></div> <div class="pad-B5 pad-L22"></div></a></li>
			        ...
			        <li><a><div class="pad-T0"> <img src="/images/easybpm/form/hiddenfield.gif" /></div><div class="pad-B0 pad-L22"></div></a></li>
			        <li><a><div class="pad-T0"> <img src="/images/easybpm/form/datetime.png" /></div><div class="pad-B0 pad-L22"></div></a></li>
			        <li><a><div class="pad-T0"> <img src="/images/easybpm/form/button.png" /></div><div class="pad-B0 pad-L22"></div></a></li>
			        <li><a><div class="pad-T0"> <img src="/images/easybpm/form/button_list.png" /></div><div class="pad-B0 pad-L22"></div></a></li>
			        <li><a><div class="pad-T3"> <img src="/images/easybpm/form/fileupload.png" /></div> <div class="pad-B5 pad-L22"> </div></a></li>
			        <li><a><div class="pad-T0"> <img src="/images/easybpm/form/imageIcon.png" /></div><div class="pad-B0 pad-L22"></div></a></li>
			        <li><a><div class="pad-T3"> <img src="/images/easybpm/form/usercontrol.png" /></div> <div class="pad-B5 pad-L22"> </div></a></li>
  			            <!-- <li><a><div class="pad-T3"> <img src="/images/easybpm/form/user_icon.png" width="14" height="14"/></div> <div class="pad-B5 pad-L22"> </div></a></li>
			        <li><a><div class="pad-T3"> <img src="/images/easybpm/form/role_icon.png" /></div> <div class="pad-B5 pad-L22"> </div></a></li>
			        <li><a><div class="pad-T3"> <img src="/images/easybpm/form/group_icon.png" /></div> <div class="pad-B5 pad-L22"> </div></a></li>
			        <li><a><div class="pad-T3"> <img src="/images/easybpm/form/template.png" /></div> <div class="pad-B5 pad-L22"> </div></a></li>
			        <li><a><div class="pad-T3"> <img src="/images/easybpm/form/richtextbox.jpg" /></div> <div class="pad-B5 pad-L22"> </div></a></li>
			        <li><a><div class="pad-T0"> <img src="/images/easybpm/form/gridview.jpg" /></div><div class="pad-B0 pad-L22 height-auto"></div></a><br/><br/><br/></li> 
			      </ul>
			  </li>
			</ul>
		</div> -->
...
<!-- 			</div> -->
			<div class="widget">
				<div class="widget-header">
					<div class="title">
						<span class="fs1" aria-hidden="true"></span> <fmt:message key="form.edit.title"/><span> - ${metaForm.formName}</span>
					</div>
				</div>
				<div class="widget-body">
					<div id="create_form" class="manageMenu_boder" >
						...
						<div id="tabs-content">
							...
							<div id="submitForm" align="right" class="pad-R10">
								<input type="hidden" id="xmlSource" name="xmlSource" value="${metaForm.xmlSource}"/>
								<input type="hidden" id="htmlSource" name="htmlSource" value="${metaForm.htmlSource}"/>
								<input type="hidden" id="htmlSourceView" name="htmlSourceView" value="${metaForm.htmlSource}"/>
								<input type="hidden" id="formName" name="formName" value="${metaForm.formName}"/>
								<input type="hidden" id="id" name="id" value="${metaForm.id}" />   
								<input type="hidden" id="version" name="version" value="${metaForm.version}"/>
								<input type="hidden" id="tableName" name="tableName" value="${metaForm.tableName}"/>
								<input type="hidden" id="templateForm" name="templateForm" value="${metaForm.templateForm}">
								<input type="hidden" id="moduleId" name="module.Id" value="${moduleId}"/>
								<input type="hidden" id="tableId" name="table.id" value="${metaForm.table.id}"/>
								<input type="hidden" id="description" name="description" value="${metaForm.description}"/>
								<input type="hidden" id="englishName" name="englishName" value="${metaForm.englishName}"/>
								<input type="hidden" id="printTemplate" name="printTemplate" value="${metaForm.printTemplate}" />
								<input type="hidden" id="backgroungImgPath" name="backgroungImgPath" value="${metaForm.backgroungImgPath}" />  
								<input type="hidden" id="isDefaultForm" name="isDefaultForm" value="${metaForm.isDefaultForm}" />
								<input id="update_cke_form" type="submit" value="<fmt:message key="button.update"/>" class="btn btn-primary" onclick="clearFormData();toggleFulscreenMode('form_submit');return getCkEditorElem('edit');"/>
								<input type="button" class="btn btn-primary" name="next" onclick="goBackToFormListView()" id="cancelButton" style="cursor: pointer;" value="<fmt:message key="button.cancel"/>" />
							</div>
							</div>
							<div id="tab-content-2" class="textalign-left">
						   		<!-- <div class="row-fluid background-white height-per-95"> -->
									...
									<input id="update_cke_form" type="submit" value="<fmt:message key="button.update"/>" class="btn btn-primary" onclick="clearFormData();toggleFulscreenMode('form_submit');return getCkEditorElem('edit');"/>					             </div>
						   		<!-- </div> -->
						   	</div>
							...
							<div id="tab-content-4" class="textalign-left">
								<%@ include file="/WEB-INF/pages/form/formPrintTemplatePreview.jsp"%> 
							</div>
						</div>
						</form:form>
					</div>
