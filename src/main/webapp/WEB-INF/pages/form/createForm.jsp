...
<!-- 						<button type="button" class="btn btn-small btn-block form_elements"  id="textfield"> -->
<!-- 							<div align="left"> -->
...
<!-- 							</div> -->
<!-- 						</button> -->
<!-- 						<button type="button" class="btn btn-small btn-block"  id="textfield"> -->
<!-- 							<div align="left"> -->
...
<!-- 						<button type="button" class="btn btn-small btn-block"  id="textfield"> -->
<!-- 							<div align="left"> -->
<!-- 								<div class="floatLeft" style="padding-right:2px;margin-top:-3px;"><img src="/images/easybpm/form/button.png" /></div>  -->
...
<!-- 						</button> -->
			        	<a class="form_elements btn btn-small btn-block"  id="textfield" href="#" > 
							<div align="left">
							<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/textbox.png" /></div>
							<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.textBox"/></span> 
							</div>
			        	</a>
					<a class="form_elements btn btn-small btn-block"  id="label" href="#" > 
							<div align="left">
							<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/label.png" /></div>
			        	...
			        	<a class="form_elements btn btn-small btn-block"  id="numberfield" href="#" > 
							<div align="left">
							<div class="floatLeft padding-right_createForm"><img src="/images/easybpm/form/number.png" /></div> 
						    <span class="fs1" aria-hidden="true"><fmt:message key="form.palette.numberBox"/></span>
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block"  id="textarea" href="#" > 
							<div align="left">
			        		<div class="floatLeft padding-right_createForm"><img src="/images/easybpm/form/textarea.png" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.textArea"/></span> 
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block"  id="select" href="#" > 
							<div align="left">
							<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/dropdown.png" /></div> 
						    <span class="fs1" aria-hidden="true"><fmt:message key="form.palette.dropDown"/></span> 
							</div>
			        	</a>
			        	 <a class="form_elements btn btn-small btn-block"  id="autocomplete" href="#" > 
							<div align="left">
							<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/autocompletefield.png" /></div>
							<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.autocomplete"/></span> 
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block"  id="radio" href="#" > 
							<div align="left">
							<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/radiobutton.png" /></div> 
						    <span class="fs1" aria-hidden="true"><fmt:message key="form.palette.radioButton"/></span> 
							</div>
			        	...
			        	<a class="form_elements btn btn-small btn-block"  id="checkbox" href="#" > 
							<div align="left">
							<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/checkbox.png" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.checkBox"/></span> 
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block"  id="hiddenfield" href="#" > 
							<div align="left">
							<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/hiddenfield.gif" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.hiddenField"/></span>
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block" id="datetimepicker" href="#"> 
							<div align="left">
			        		<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/datetime.png" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.dateTime"/></span>
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block" id="button" href="#"> 
							<div align="left">
			        		<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/submitbutton.png" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.addButton"/></span>
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block" id="showbuttons" href="#"> 
							<div align="left">
			        		<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/button_list.png" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.showButtons"/></span>
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block" id="fileupload" href="#"> 
							<div align="left">
			        		<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/fileupload.png" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.fileUpload"/></span>
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block" id="image" href="#"> 
							<div align="left">
			        		<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/imageIcon.png" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.Image"/></span>
							</div>
			        	</a>
			            <a class="form_elements btn btn-small btn-block" id="usercontrol" href="#"> 
							<div align="left">
			                   <div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/usercontrol.png" /></div> 
			                   <span class="fs1" aria-hidden="true"><fmt:message key="form.palette.userControl"/></span>
							</div>
			            </a>
			        	<a class="form_elements btn btn-small btn-block" id="userlist" href="#"> 
							<div align="left">
			        		<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/user_icon.png" width="14" height="14"/></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.user"/></span>
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block" id="departmentlist" href="#"> 
							<div align="left">
			        		<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/departments.png" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.department"/></span>
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block" id="rolelist" href="#"> 
							<div align="left">
			        		<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/role_icon.png" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.role"/></span>
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block" id="grouplist" href="#"> 
							<div align="left">
			        		<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/group_icon.png" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.group"/></span>
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block" id="subforms"href="#"> 
							<div align="left">
			        		<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/subformm.png" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.subForm"/></span>
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block" id="templates" href="#"> 
							<div align="left">
			        		<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/template.png" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.templates"/></span>
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block" id="richtextbox" href="#"> 
							<div align="left">
			        		<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/richtextbox.jpg" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.richtextbox"/></span>
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block" id="gridviewcontrol" href="#"> 
							<div align="left">
			        		<div class="floatLeft padding-right_createForm" ><img src="/images/easybpm/form/gridview.jpg" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.gridview"/></span>
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block" id="tabcontrol" href="#"> 
							<div align="left">
			        		<div class="floatLeft padding-right_createForm" ><img src="/scripts/ckeditor/plugins/tabcontrol/images/tab-add-icon.png" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.tabDesign"/></span>
							</div>
			        	</a>
			        	<a class="form_elements btn btn-small btn-block" id="onloadevent" href="#"> 
							<div align="left">
			        		<div class="floatLeft padding-right_createForm" ><img src="/scripts/ckeditor/plugins/onloadevent/images/onload.gif" /></div> 
			        		<span class="fs1" aria-hidden="true"><fmt:message key="form.palette.formOnLoadScript"/></span>
							</div>
			        	</a>
						</div>
...
<!-- 					<div class="span12"> -->
<!-- 						<div class="titleBG"> -->
<%-- 				     		<span class="floatLeft fontSize14 pad-L10 pad-T10"><fmt:message key="formdesigner.title"/></span><span id="showFormName" class="floatLeft fontSize14 pad-T10"></span> --%>
<!-- 				     		<span class="floatRight fontSize14 pad-L10 pad-T2"> -->
...
<!-- 				     			</div> -->
<!-- 				     		</span> -->
<%-- 				     		<div class="floatRight pad-T2"><ul id="tabs"><li id="tabs-1" class="selected"><fmt:message key="form.design"/></li><li id="tabs-2"><fmt:message key="form.hTMLSource"/></li><li id="tabs-3"><fmt:message key="form.preview"/></li></ul></div> --%>
<!-- 						</div> -->
<!-- 					</div> -->
<!-- 				</div> -->
				<div class="widget">
					...
					<div class="widget-body">
						...
						<div id="tabs-content">
							...
							<div id="submitForm" align="right" class="pad-R10">
								...
								<input id="update_cke_form" type="submit" value="Save Form" class="btn btn-primary" onclick="clearFormData();toggleFulscreenMode('form_submit');return getCkEditorElem('create');"/>
								<input type="button" class="btn btn-primary" name="next" onclick="goBackToFormListView()" id="cancelButton" style="cursor: pointer;" value="Cancel" />
							</div>
							</div>
							<div id="tab-content-2" class="textalign-left">
						   		<!-- <div class="row-fluid background-white height-per-95"> -->
						   		 ...
						   		 <div id="updateForm" class="mar-B15 mar-R15  mar-T10" align="right">
					             	<input id="save_cke_form" type="submit" value="Save Form" onclick= "clearFormData();toggleFulscreenMode('form_submit');return setCKEditorSource('create');clearFormData();" class="btn btn-primary"/>
					             </div>
						   		<!-- </div> -->
						   	</div>
