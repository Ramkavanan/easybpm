	...
	<div class="row-fluid">
		<div class="span12">
			<div class="page-header">
				<h2 ><fmt:message key="schedule.title"/>	</h2>
			</div>
	...
	<div class="row-fluid" id="eventOwnerDiv">
		...
		<center>
			<table id="schedule-filter">
				<tr>
					<td><label for="Assigned"  class="control-label style3 style18"><fmt:message key="scheduleForm.assigned"/></label></td>
