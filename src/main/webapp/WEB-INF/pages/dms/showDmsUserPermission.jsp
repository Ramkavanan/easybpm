...
<div class="container-fluid padding5">
	<div class="row-fluid">
		<div class="span12">
			<spring:bind path="dmsUserPermission.*">
	...
	<div class="row-fluid">
	    <div class="span12">
	    	<form:form id="dmsUserPermission" commandName="dmsUserPermission" method="post" autocomplete="off" modelAttribute="dmsUserPermission" action="bpm/dms/saveDmsUserPermission" onSubmit="_execute('popupDialog','')">
			    ...
			    <div class="row-fluid control-group" id="usersDiv">
			    	<div class="span2">
			    		<eazytec:label styleClass="control-label style3 style18" key="permission.users"/>
			    	</div>
			    	<div class="span10">
			    		<input type="text" name="users" id="users" class="large" onclick="showUserSelection('User', 'multi', 'users', this, '');"/>
			    	</div>
				</div>
				 ...
				 <div class="row-fluid control-group">
				    	...
				    	<div class="span3">
							<div class="button" id="saveButtonDiv">
								<button type="submit" class="btn btn-primary normalButton padding0 line-height0" name="save" id="saveButton" onclick="return validateDmsUserPermission(this);">
