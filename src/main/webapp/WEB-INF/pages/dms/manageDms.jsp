...
<div class="page-header">
		<h2><fmt:message key="folder.heading"/></h2>
	</div>
	<div id="header_links" align="right">
		<a class="padding10" href="#bpm/dms/documentForm" onClick="return createFolderDocumentForm();" ><button class="btn"><fmt:message key="button.createNew"/></button></a>
	</div> 
