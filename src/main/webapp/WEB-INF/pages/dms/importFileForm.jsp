...
<script type="text/javascript">
	...
	$("#save").click(function(event) { 
		...
		if(uploadedFiles.value == ""){
			openMessageBox("Error","File Selecttion filed should not be Empty,So Please select the File to Upload","error",true);
		...
		if(fileName = "" || fileName.length <=0) {
			openMessageBox("Error","Document Form Name should not be Empty","error", true);
		        event.preventDefault();
		}
	});
