	...
	var level = data.inst.get_path().length;
	 ...
	 if(level != 1){
		 ...
		 if(currentNode.indexOf("AllForm") > -1){
			 ...
			 _execute('rightPanel',params);
			 $("#module_title").html("");
		   	 $("#module_title").html("Create Module");
		 }
	}
	 ...
	 if(level == 3 && parentNode.indexOf("Tables") != -1){
		...
		if(currentNode.indexOf("ListViews") != -1){
			 ...
			 _execute('rightPanel',params);
			 $("#module_title").html("");
			 $("#module_title").html("Create List View");
		}else if(currentNode.indexOf("Recycle") != -1){
			 var moduleid=data.rslt.obj.attr("moduleid");
 			 var listViewParams=[{"moduleid":moduleid}];
 			 ...
 			 $("#module_title").html("");
		   	 $("#module_title").html("Recycle List View");
		}
...
//==============================================Module functions=======================================================================
	...
	/* function orderingModule(orderingType){
		var selected_nodes = $("#module_relation_tree").jstree("get_selected", null, true);
		var moduleId=selected_nodes.attr("id");
		var moduleName=selected_nodes.attr("name");
		
		if(moduleId && moduleId!=undefined){
			var params="moduleId="+moduleId+"&orderingType="+orderingType;
			var content="Are you sure you want to change the order of : "+moduleName+" ?";
			$.msgBox({
			    title: "Confirm",
			    content: content,
			    type: "confirm",
			...
			$.msgBox({
			    title: "Message",
			    content: "Select a Module to sort",
			});	
		}	
...
<div id="parent_container">
	<div class="page-header">
		<div class="pull-left">
			<h2><fmt:message key="admin.module.list"/></h2>
		</div>
		</div>
			...
			<div class="span9">
				<div class="widget">
					<div class="widget-header">
						...
						<div id="header_links" align="right" style="margin-top:-2px;"></div>
					</div>
					<div class="widget-body">
