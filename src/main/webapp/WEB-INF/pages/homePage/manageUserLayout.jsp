...
<div class="row-fluid">
		...
		<div class="page-header">
			<div class="pull-left">
				<h2><fmt:message key="layout.manageLayout"/></h2>
			</div>
			<div id="layout_header_links" align="right">
            		<a  id="widget" href="javascript:void(0);" onClick="showUserWidgetSelection('Select Widget', 'multi' , 'userwidgetNames', document.getElementById('widgetNamesHidden'), '');" class="floatRight createEvent pad-R20 pad-T10 text-underline"  ><button class="btn"><fmt:message key="widget.select"/></button></a> 
			  		<a  id="createLayout" href="javascript:void(0);"   onClick="showUserLayoutSelection('Select Layout', 'single' , 'noOfWidget', document.getElementById('noOfWidget'), '');" class="floatRight createEvent pad-R20 pad-T10 text-underline" ><button class="btn"><fmt:message key="layout.select"/></button></a>
	        </div>
		</div>
		<div class="span12">
			<div class="widget">
