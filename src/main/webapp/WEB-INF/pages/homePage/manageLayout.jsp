...
<div class="row-fluid">
		...
		<div class="page-header">
			...
			<div id="layout_header_links" align="right">
            		<a  id="widget" href="javascript:void(0);" onClick="showWidgetSelection('Widget', 'multi' , 'widgetNames', document.getElementById('widgetNames'), '');" class="floatRight createEvent pad-R20 pad-T10 text-underline"  ><fmt:message key="widget.select"/></a> 
