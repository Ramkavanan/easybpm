...
<div class="height10"></div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			  	...
			  	var status = '${status}';
			  	if(status == '' || status == null || status == 'Not Connected'){
	...
	<div class="row-fluid">
				...
				<form:form commandName="user" method="post" action="bpm/mail/jwma/saveEmailSetting" id="userMailForm" cssClass="form-horizontal no-margin"  onSubmit="_execute('target','')">
					...
					<%-- <div class="control-group">
			            ...
			            <div class="controls">
			                <form:input path="firstName" id="firstName" maxlength="50" class="span6" readonly="true"/>
			    	    </div>
		  			</div>
			    	...
			    	<div class="control-group">
			            ...
			            <div class="controls">
			                <form:input path="lastName" id="lastName" maxlength="50" class="span6" readonly="true"/>
					  	</div>
					</div> --%>
					<div class="control-group">
