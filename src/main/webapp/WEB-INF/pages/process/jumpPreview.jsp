...
<div id="jump-full">
	...
	<input type="button" onclick="jumpToTask(${canSave},'${formId}');" value="Jump" style="vertical-align:top;" class ="btn btn-primary">
	<%}else if(jumpType.equals("backOff")){ %>
	<input type="button" onclick="jumpToTask(${canSave},'${formId}');" value="Back Off" style="vertical-align:top;" class ="btn btn-primary">
	<%}else { %>
		<input type="button" onclick="jumpToTask(${canSave},'${formId}');" value="Return" style="vertical-align:top;" class ="btn btn-primary">
	<% } %>
