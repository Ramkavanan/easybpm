...
<script type="text/javascript" src="<c:url value='/oryx-resources/customtree/build/yahoo.js'/>"></script>
<script type="text/javascript" src="<c:url value='/oryx-resources/customtree/build/event.js'/>"></script>
<script type="text/javascript" src="<c:url value='/oryx-resources/customtree/build/treeview.js'/>"></script>
<script type="text/javascript" src="<c:url value='/oryx-resources/customtree/build/jktreeview.js'/>"></script>
...
<link rel="stylesheet" type="text/css" href="<c:url value='/oryx-resources/customtree/css/multi/tree.css'/>" />
<!-- erdf schemas -->
	...
	<div class="span12" id="target_iframe_div_hd">
		<div class="titleBG">
			...
			if(processName != null && processName.length() >0) {%>
				<span style="color: #4D4D4D;float: left;font-weight: 100;margin: 0;padding: 0;font-size: 31.5px;line-height: 38px;margin-top:-8px;">Edit Process - <%=processName %> </span>
			<%} else {%>
				<span style="color: #4D4D4D;float: left;font-weight: 100;margin: 0;padding: 0;font-size: 31.5px;line-height: 38px;margin-top:-8px;">Create Process  </span>
			<% }
			%>
			...
			<div class="floatRight pad-T2 pad-R5" style="margin-top:-3px;">
				<button class="btn btn-primary" id="tabs-1" onclick="designView()" type="button">Design</button>
   				<button class="btn hidden-tablet" id="tabs-2" onclick="sourceView()" type="button">Source</button>
				<!-- <ul id="tabs">
...
<body style="overflow:hidden;">
	...
	<div id="oryx-canvas123" name="oryx-canvas123" style="padding-top:7px;"></div>
