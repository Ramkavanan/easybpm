...
ORYX.I18N.ERDFSupport.pasteProperyTitle = "Error";
ORYX.I18N.ERDFSupport.pasteProperyText = "Property types differ, Please paste same node propeties.";
ORYX.I18N.ERDFSupport.pasteProperyTextWarning = "You should copy the field property before paste.";
...
ORYX.I18N.PropertyWindow.addorrem = "Add/Remove";
ORYX.I18N.PropertyWindow.complex = "Editor for a Complex Type";
ORYX.I18N.PropertyWindow.customTreeSelect = "Select Resources";
ORYX.I18N.PropertyWindow.text = "Editor for a Text Type";
ORYX.I18N.PropertyWindow.ok = "Ok";
ORYX.I18N.PropertyWindow.submit = "Submit";
...
ORYX.I18N.PropertyWindow.task = "任务";
ORYX.I18N.PropertyWindow.form = "形式";
ORYX.I18N.PropertyWindow.organizer = "组织者";
ORYX.I18N.PropertyWindow.coordinator = "统筹";
ORYX.I18N.PropertyWindow.reader = "读者";
ORYX.I18N.PropertyWindow.creator = "创造者";
ORYX.I18N.PropertyWindow.processedUser = "处理用户";
ORYX.I18N.PropertyWindow.admin = "管理员";
ORYX.I18N.PropertyWindow.process = "过程";
ORYX.I18N.PropertyWindow.workFlowAdmin = "工作流管理";
ORYX.I18N.PropertyWindow.ofOrganizer = "主办单位";
ORYX.I18N.PropertyWindow.ofCoordinator = "协调员";
ORYX.I18N.PropertyWindow.ofReader = "阅读器";
ORYX.I18N.PropertyWindow.ofCreator = "造物主";
ORYX.I18N.PropertyWindow.ofProcessedUser = "加工用户";
ORYX.I18N.PropertyWindow.ofWorkFlowAdmin = "工作流程管理员";
ORYX.I18N.PropertyWindow.isStartNode = "是起始节点";
ORYX.I18N.PropertyWindow.jspForm = "JSP表单";
ORYX.I18N.PropertyWindow.notificationMessage = "通知消息";
ORYX.I18N.PropertyWindow.urgeMessage = "恳请留言";
ORYX.I18N.PropertyWindow.startEvent = "启动事件";

ORYX.I18N.PropertyWindow.processTimeSetting = "过程中时间设置";
ORYX.I18N.PropertyWindow.ptsError = "请设置最大天除警告天更高";
ORYX.I18N.PropertyWindow.timeSetting = "时间设置 - ";
ORYX.I18N.PropertyWindow.maxDays = "最大日";
ORYX.I18N.PropertyWindow.warningDays = "警告天";
ORYX.I18N.PropertyWindow.dateType = "日期类型";
ORYX.I18N.PropertyWindow.urgeTimes = "督促时报";
ORYX.I18N.PropertyWindow.frequence = "频率";
ORYX.I18N.PropertyWindow.dealTimeout = "如果处理超时";
ORYX.I18N.PropertyWindow.hours = "小时";
ORYX.I18N.PropertyWindow.notificationTYpe = "通知类型";
ORYX.I18N.PropertyWindow.fillForm = "填写表格";
ORYX.I18N.PropertyWindow.fillField = "填写现场";
ORYX.I18N.PropertyWindow.fillValue = "填充值";
ORYX.I18N.PropertyWindow.fillType = "填充类型";
ORYX.I18N.PropertyWindow.isSkip = "是跳过";
ORYX.I18N.PropertyWindow.formFieldAutomatic = "表单域自动";
ORYX.I18N.PropertyWindow.formFields = "表单域";
ORYX.I18N.PropertyWindow.fromForm = "从形式";
ORYX.I18N.PropertyWindow.fromFormField = "从表单域";
ORYX.I18N.PropertyWindow.onRead = "在读";
ORYX.I18N.PropertyWindow.onUpdate = "关于更新";
ORYX.I18N.PropertyWindow.onCreate = "在创建";
ORYX.I18N.PropertyWindow.formError = "请选择表格";
ORYX.I18N.PropertyWindow.cts = "自定义树中选择";
ORYX.I18N.PropertyWindow.members = "会员";
ORYX.I18N.PropertyWindow.premission = "权限";
ORYX.I18N.PropertyWindow.dynamicTransactor = "动态交易者";
ORYX.I18N.PropertyWindow.selectAll = "全选";
ORYX.I18N.PropertyWindow.editable = "可编辑";
ORYX.I18N.PropertyWindow.required = "需要";
ORYX.I18N.PropertyWindow.readOnly ="只读";
ORYX.I18N.PropertyWindow.hidden = "隐";
ORYX.I18N.PropertyWindow.noOutput = "无输出";
ORYX.I18N.PropertyWindow.chooseCondition = "选择条件";
ORYX.I18N.PropertyWindow.parameter = "参数";
ORYX.I18N.PropertyWindow.relation = "关系";
ORYX.I18N.PropertyWindow.join1 = "加入";
ORYX.I18N.PropertyWindow.operation = "手术";
ORYX.I18N.PropertyWindow.transactorRelationship = "办理人关系";
ORYX.I18N.PropertyWindow.operator = "操作者";
ORYX.I18N.PropertyWindow.permissionError = "请设置字段权限";
ORYX.I18N.PropertyWindow.operationFunction = "操作功能：";
ORYX.I18N.PropertyWindow.operationPermission = "操作权限";
ORYX.I18N.PropertyWindow.sfn = "脚本函数名称：";
ORYX.I18N.PropertyWindow.startScript = "启动脚本";
ORYX.I18N.PropertyWindow.endScript = "结束脚本";
ORYX.I18N.PropertyWindow.opinion = "意见";

if(!ORYX.I18N.ShapeRepository) ORYX.I18N.ShapeRepository = {};
ORYX.I18N.ShapeRepository.title = "Shape Repository";

ORYX.I18N.Save.dialogDesciption = "请输入过程的详细信息。";
ORYX.I18N.Save.dialogLabelTitle = "标题";
ORYX.I18N.Save.dialogLabelName = "名称";
ORYX.I18N.Save.dialogLabelDesc = "描述";
ORYX.I18N.Save.dialogLabelType = "Type";
ORYX.I18N.Save.dialogLabelClassification = "分类";
