...
}ORYX.Plugins.UMLSequence=Clazz.extend({facade:undefined,construct:function(a){this.facade=a;
this.facade.registerOnEvent("layout.uml.sequence.combinedFragment",this.sendToBack.bind(this));
this.facade.registerOnEvent("layout.uml.sequence.onLifeline",this.centerOnLifeline.bind(this));
this.facade.registerOnEvent("layout.uml.sequence.terminator",this.centerTerminatorOnLifeline.bind(this))
}get ,sendToBack:function sendToBack(b){var a=b.shape;
a.node.parentNode.insertBefore(a.node,a.node.parentNode.firstChild)
}get ,centerOnLifeline:function centerOnLifeline(c){var a=c.shape;
var b=a.getParentShape();
var d=b.absoluteCenterXY().x-a.absoluteCenterXY().x;
a.bounds.moveBy(d,0)
}get ,centerTerminatorOnLifeline:function centerTerminatorOnLifeline(e){var b=e.shape;
var d=b.getParentShape();
var c=d.absoluteCenterXY().x-b.absoluteCenterXY().x;
var a=d.bounds.lowerRight().y-b.absoluteCenterXY().y;
b.bounds.moveBy(c,a)
}get });
if(!ORYX.Plugins){ORYX.Plugins=new Object()
