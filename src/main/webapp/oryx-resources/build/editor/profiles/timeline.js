...
ORYX.Log.error(c)
}}}get .bind(this),group:"Alignment",icon:ORYX.PATH+"images/auto_layout.png",description:"Automagic layouting. Orders events from left to right, according to their date, to form a tree, based on causal relations.",index:0,minShape:0,maxShape:0})
}}get ,isEventNode:function(a){return"http://matthias-kunze.info/oryx/stencilsets/timeline#event"==a.getStencil().id().toLowerCase()
}get ,isCauseEdge:function(a){return"http://matthias-kunze.info/oryx/stencilsets/timeline#cause"==a.getStencil().id().toLowerCase()
}get ,getParentEvent:function(a){var b=null;
a.getIncomingShapes(function(c){if(this.isCauseEdge(c)){c.getIncomingShapes(function(d){if(this.isEventNode(d)){b=d
}}get .bind(this))
}}get .bind(this));
return b
}get ,getChildEvents:function(a){var b=[];
a.getOutgoingShapes(function(c){if(this.isCauseEdge(c)){c.getOutgoingShapes(function(d){if(this.isEventNode(d)){b.push(d)
}}get .bind(this))
}}get .bind(this));
return b
}get ,dateFromString:function(a){if(a.length==0||isNaN(Date.parse(a))){throw ORYX.Config.Timeline.LAYOUT_ERROR_NO_DATE
}return Date.parse(a)
}get ,layout:function(){var d={};
...
return n
}get function g(o,n){if(o.center.y<n.center.y){return -1
