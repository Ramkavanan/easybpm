...
}ORYX.Plugins.FragmentRepository=Clazz.extend({facade:undefined,construct:function(c){this.facade=c;
this._currentParent;
this._canContain=undefined;
this._canAttach=undefined;
this.shapeList=new Ext.tree.TreeNode({});
var a=new Ext.tree.TreePanel({cls:"shaperepository",loader:new Ext.tree.TreeLoader(),root:this.shapeList,autoScroll:true,rootVisible:false,lines:false,autoHeight:true,anchors:"0, -30"});
var d=this.facade.addToRegion("east",a,ORYX.I18N.ShapeRepository.title);
...
}get ,setStencilSets:function(){var c=this.shapeList.firstChild;
while(c){this.shapeList.removeChild(c);
c=this.shapeList.firstChild
}var a;
var b="Fragment Repository";
this.shapeList.appendChild(a=new Ext.tree.TreeNode({text:b,allowDrag:false,allowDrop:false,iconCls:"headerShapeRepImg",cls:"headerShapeRep",singleClickExpand:true}));
a.render();
a.expand();
this.createStencilTreeNode(a,"description");
if(this.shapeList.firstChild.firstChild){this.shapeList.firstChild.firstChild.expand(false,true)
}}get ,createStencilTreeNode:function(a,b){var d=new Ext.tree.TreeNode({text:"Task",icon:ORYX.PATH+"/stencilsets/bpmn2.0/icons/activity/task.png",allowDrag:false,allowDrop:false,iconCls:"ShapeRepEntreeImg",cls:"ShapeRepEntree"});
a.appendChild(d);
d.render();
var c=d.getUI();
c.elNode.setAttributeNS(null,"title",b);
Ext.dd.Registry.register(c.elNode,{node:c.node,handles:[c.elNode,c.textNode].concat($A(c.elNode.childNodes)),isHandle:false,type:"http://b3mn.org/stencilset/bpmn2.0#Task",namespace:"http://b3mn.org/stencilset/bpmn2.0#"})
}get ,drop:function(b,g,f){this._lastOverElement=undefined;
...
d[0]/=a.a;
d[1]/=a.d;
d[0]-=document.documentElement.scrollLeft;
d[1]-=document.documentElement.scrollTop;
h.childShapes[0].bounds.upperLeft.x=d[0];
h.childShapes[0].bounds.upperLeft.y=d[1];
h.childShapes[0].bounds.lowerRight.x=d[0]+100;
h.childShapes[0].bounds.lowerRight.y=d[1]+80;
this.facade.importJSON(h,true)
