...
}get ,addReadingDirectionOnLoad:function(a){this.facade.getCanvas().edges.each(function(b){if(b.properties["oryx-direction"]=="left"||b.properties["oryx-direction"]=="right"){this.addReadingDirection(b)
}}get .bind(this))
}get ,calculateLabelHeight:function(a,b){var d=a.getFontSize();
var c=1;
b.scan("
",function(){c+=1
}get );
return c*d+0.75
}get ,handlePropertyChanged:function(a){if(a.key=="oryx-name"){this.addReadingDirection(a.elements[0])
}}get ,handleLayoutClass:function(b){var h=b.shape;
if(h.propertiesChanged["oryx-abstract"]==true){var j=b.shape.getLabels().find(function(o){return o.id==(b.shape.id+"className")
}get );
if(h.properties["oryx-abstract"]==true){j.node.setAttribute("font-style","italic")
}else{j.node.setAttribute("font-style","normal")
...
var d=b.shape.getLabels().find(function(o){return o.id==(b.shape.id+"attributes")
}get );
var c=b.shape.getLabels().find(function(o){return o.id==(b.shape.id+"methods")
}get );
var g=b.shape._svgShapes.find(function(o){return o.element.id==(b.shape.id+"separator")
}get ).element;
...
}}get ,handleLayoutList:function(e){var c=e.shape;
...
}}get ,handleLayoutAssociation:function(a){this.addReadingDirection(a.shape)
}get ,addReadingDirection:function(a){var b=a.getLabels().find(function(c){return c.id==(a.id+"name")
}get );
...
}get ,handleLayoutQualifiedAssociation:function(d){var a=d.shape;
