...
this.facade.offer({name:"Run XForm with Orbeon",functionality:this.exportIt.bind(this),group:ORYX.I18N.XFormsSerialization.group,icon:ORYX.PATH+"images/xforms_orbeon_export.png",description:"XForms export for Orbeon",index:1,minShape:0,maxShape:0})
}get ,exportIt:function(){this.facade.raiseEvent({type:ORYX.CONFIG.EVENT_LOADING_ENABLE});
window.setTimeout((function(){this.exportSynchronously();
this.facade.raiseEvent({type:ORYX.CONFIG.EVENT_LOADING_DISABLE})
}get ).bind(this),10);
return true
}get ,exportSynchronously:function(){var c=location.href;
...
}get ,onFailure:function(d){var e=window.open("");
e.document.write(d.responseText)
}get })
}catch(a){this.facade.raiseEvent({type:ORYX.CONFIG.EVENT_LOADING_DISABLE});
Ext.Msg.alert(ORYX.I18N.Oryx.title,a)
}}get ,checkClientXFormsSupport:function(){if(!clientSupportsXForms){var a=ORYX.I18N.XFormsSerialization.noClientXFormsSupportDesc;
...
this.facade.offer({name:ORYX.I18N.XFormsSerialization.exportXForms,functionality:this.exportXForms.bind(this),group:ORYX.I18N.XFormsSerialization.group,icon:ORYX.PATH+"images/xforms_export.png",description:ORYX.I18N.XFormsSerialization.exportXFormsDesc,index:2,minShape:0,maxShape:0})
}get ,exportXForms:function(){this._showCssDialog()
...
return true
}get ,exportSynchronously:function(b){var d=location.href;
...
b.show()
}}get ,_showCssDialog:function(a){var c=new Ext.form.FormPanel({baseCls:"x-plain",labelWidth:50,defaultType:"textfield",items:[{text:ORYX.I18N.XFormsSerialization.selectCss,style:"font-size:12px;margin-bottom:10px;display:block;",anchor:"100%",xtype:"label"},{xtype:"textarea",hideLabel:true,name:"msg",anchor:"100% -30"}]});
...
b.hide()
}get .bind(this)},{text:ORYX.I18N.XFormsSerialization.close,handler:function(){b.hide()
}get .bind(this)}]});
...
this.facade.offer({name:ORYX.I18N.XFormsSerialization.importXForms,functionality:this.importXForms.bind(this),group:ORYX.I18N.XFormsSerialization.group,icon:ORYX.PATH+"images/xforms_import.png",description:ORYX.I18N.XFormsSerialization.importXFormsDesc,index:3,minShape:0,maxShape:0})
}get ,importXForms:function(){this._showImportDialog()
...
}get ,handleLayoutLabel:function(d){var a=d.shape;
var c=d.moveX;
var b=d.moveY;
...
}}get ,handleLayoutLabelButton:function(b){var a=b.shape;
...
}}get ,handleLayoutItem:function(e){var b=e.shape;
...
var c=0;
a.each(function(k){var j=k.bounds.upperLeft();
var h=k.bounds.lowerRight();
if(k.getStencil().id()==="http://b3mn.org/stencilset/xforms#Choices"){j.y=c+25;
c+=25
}else{j.y=c+5;
c+=5
}h.y=j.y+k.bounds.height();
c+=k.bounds.height();
j.x=30;
h.x=d;
k.bounds.set(j,h)
...
if(f.length>0){f.each(function(j){var k=j.bounds.upperLeft();
var h=j.bounds.lowerRight();
k.y=-j.bounds.height()-1;
h.y=-1;
k.x=0;
h.x=j.bounds.width();
j.bounds.set(k,h)
}get )
}}get ,handleLayoutCase:function(e){var a=e.shape;
...
var b=5;
d.each(function(j){var h=j.bounds.upperLeft();
var g=j.bounds.lowerRight();
h.y=b;
g.y=h.y+j.bounds.height();
b+=j.bounds.height()+5;
h.x=0;
g.x=c;
j.bounds.set(h,g)
...
}}get ,handleLayoutLabelItem:function(b){var a=b.shape;
var c=a.getChildNodes(false).findAll(function(d){return(d.getStencil().id()==="http://b3mn.org/stencilset/xforms#Label")
}get );
...
}}get ,handleLayoutAction:function(d){var a=d.shape;
var e=a.getChildNodes(false);
if(e.length>0){e=e.sortBy(function(g){return g.bounds.upperLeft().y
}get );
var c=5;
e.each(function(j){var h=j.bounds.upperLeft();
var g=j.bounds.lowerRight();
h.y=c;
g.y=h.y+j.bounds.height();
c+=j.bounds.height()+5;
h.x=2;
g.x=2+j.bounds.width();
j.bounds.set(h,g)
}get );
var f=a.bounds.upperLeft();
