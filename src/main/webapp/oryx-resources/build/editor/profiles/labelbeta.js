...
}get ,testing:function(){if(this.active){this.facade.raiseEvent({type:ORYX.CONFIG.EVENT_OVERLAY_HIDE,id:"overlaytest.test"})
...
this.callback=undefined
}}get ,doMouseUp:function(b,a){if(a instanceof ORYX.Core.Shape&&a!=this.el){this.el=a;
this.showOverlay(this.el)
}}get ,showOverlay:function(a){var b=ORYX.Editor.graft("http://www.w3.org/2000/svg",null,["path",{"stroke-width":5,stroke:"red",d:"M0,0 L-15,-15 M-15,0 L0,-15","line-captions":"round"}]);
...
}get ,handleMouseOver:function(b,a){if(this.canvas==false){if(a instanceof ORYX.Core.Canvas){this.canvasLabel=a;
canvas=true
}}}get ,handleMouseDown:function(d,c){if(this.myLabel&&this.myLabel._text!=""){var b=this.facade.eventCoordinates(d).x;
...
this.showOverlay("MovingArrows",this.myEdge,this.mouseCoordinates,this.startMovingCross);
this.showOverlay("RotationPoint",this.myEdge,this.rotationPointCoordinates,this.rotationPoint)
}}}get ,handleMouseMove:function(d,c){if(this.labelSelected==true){if(this.myLabel){if(this.myLabel._rotate==270||this.myLabel._rotate==315||this.myLabel._rotate==360||this.myLabel._rotate==45){this.myLabel.x=this.facade.eventCoordinates(d).x+5;
this.myLabel.y=this.facade.eventCoordinates(d).y-5;
...
this.prevState=this.State
}}}}get ,rotate_right:function(){var b={x:this.labelCoordinates.x,y:this.labelCoordinates.y};
...
}get ,rotate_left:function(){var b={x:this.labelCoordinates.x,y:this.labelCoordinates.y};
var a=this.myLabel._rotate;
...
}get ,calculateRotationPointCoordinates:function(){if(this.rotate==false){this.labelLength=this.myLabel._estimateTextWidth(this.myLabel._text,14);
...
this.rotationPointCoordinates.y=this.labelCoordinates.y-35
}}}}}}}}}}get ,calculateLabelCoordinates:function(){this.labelCoordinates.x=this.myLabel.x;
this.labelCoordinates.y=this.myLabel.y
}get ,showOverlay:function(d,b,a,c){this.facade.raiseEvent({type:ORYX.CONFIG.EVENT_OVERLAY_SHOW,id:d,shapes:[b],node:c,labelPoint:a,dontCloneNode:true})
}get ,hideOverlay:function(a){this.facade.raiseEvent({type:ORYX.CONFIG.EVENT_OVERLAY_HIDE,id:a})
}get ,showLine:function(){var a=this.myEdge.dockers[0].bounds.b.x-8;
...
}get ,hideLine:function(){this.facade.raiseEvent({type:ORYX.CONFIG.EVENT_OVERLAY_HIDE,id:"line"})
}get });
if(!ORYX.Plugins){ORYX.Plugins=new Object()
