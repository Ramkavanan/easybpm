...
}get ,showOverlay:function(c,f){if(!f){this.raisedEventIds=[];
this.active=!this.active;
return
}var b={command:"undef"};
var e=new Ext.Window({layout:"fit",width:500,height:350,closable:true,plain:true,modal:true,id:"optionsPopup",buttons:[{text:"Submit",handler:function(){b=a.getForm().getValues(false);
e.close();
this.issueQuery(b)
}get .bind(this)},{text:"Abort",handler:function(){e.close()
}get .bind(this)}]});
var g=new Ext.form.TextField({fieldLabel:"Model ID",name:"modelID",grow:true,});
g.hide();
...
var l=new Array();
var k,m;
var h=j.getElementsByTagName("ProcessGraph");
for(k=0;
k<h.length;
k++){m=h.item(k);
var e=m.getAttributeNode("modelID").nodeValue;
l.push({id:e,elements:this.processResultGraph(m),metadata:"",description:this.processMatchDescription(m)})
}try{this.processProcessList(l)
...
Ext.Msg.alert(ORYX.I18N.Oryx.title,"Server encountered an error ("+d.statusText+").
"+d.responseText)
}get .bind(this)})
}catch(a){this.facade.raiseEvent({type:ORYX.CONFIG.EVENT_LOADING_DISABLE});
Ext.Msg.alert(ORYX.I18N.Oryx.title,a)
}}get ,processResultGraph:function(b){var d=new Array();
for(var a=0;
...
}get ,processMatchDescription:function(c){var b=new Array();
for(var a=0;
...
}get ,processProcessList:function(e){if(e.length==0){Ext.Msg.alert(ORYX.I18N.Oryx.title,"Found no matching processes!");
return
...
var a=new Ext.Window({layout:"fit",width:500,height:300,closable:true,plain:true,modal:true,autoScroll:true,title:"Query Result",id:"procResPopup",buttons:[{text:"Close",handler:function(){a.close()
}get .bind(this)}]});
...
var d;
d=ORYX.Core.StencilSet.stencil(a+"StartEvent");
c=new ORYX.Core.Node({eventHandlerCallback:this.facade.raiseEvent},d);
this.facade.getCanvas().add(c);
return c
}get ,drawActivity:function(f){var b=this.facade.getCanvas();
var c;
var e={};
e.x=f;
e.y=0;
var a=this.facade.getStencilSets().keys()[0];
var d;
d=ORYX.Core.StencilSet.stencil(a+"Task");
c=new ORYX.Core.Node({eventHandlerCallback:this.facade.raiseEvent},d);
c.setProperty("oryx-name","A");
this.facade.getCanvas().add(c);
return c
}get ,drawPath:function(f,e){var c;
var b=this.facade.getCanvas();
var a=this.facade.getStencilSets().keys()[0];
var d=ORYX.Core.StencilSet.stencil(a+"Path");
...
c.setProperty("oryx-temporalproperty","Leads to");
this.facade.getCanvas().add(c);
return c
}get });
if(!ORYX.Plugins){ORYX.Plugins=new Object()
}ORYX.Plugins.GlobalAbsencePattern=ORYX.Plugins.AbstractPlugin.extend({facade:undefined,construct:function(a){this.facade=a;
this.active=false;
this.raisedEventIds=[];
this.facade.offer({name:ORYX.I18N.GlobalAbsencePattern.name,functionality:this.showOverlay.bind(this),group:ORYX.I18N.GlobalAbsencePattern.group,dropDownGroupIcon:ORYX.PATH+"images/controlFlow.png",icon:ORYX.PATH+"images/GlobalAbsencePattern.png",description:ORYX.I18N.GlobalAbsencePattern.desc,index:0,toggle:true,minShape:0,maxShape:0})
}get ,showOverlay:function(b,c){if(!c){this.raisedEventIds=[];
this.active=!this.active;
return true
}var a={command:"undef"};
this.createGlobalAbsencePattern(a);
b.toggle()
}get ,createGlobalAbsencePattern:function(c){try{var a=-30;
var e=this.drawStartEvent(a);
a=a+150;
var d=this.drawEndEvent(a);
this.drawPath(e,d)
}catch(b){Ext.Msg.alert(ORYX.I18N.Oryx.title,b)
}}get ,drawStartEvent:function(f){var b=this.facade.getCanvas();
var c;
...
this.facade.getCanvas().add(c);
return c
}get ,drawEndEvent:function(f){var b=this.facade.getCanvas();
var c;
var e={};
e.x=f;
e.y=0;
var a=this.facade.getStencilSets().keys()[0];
var d;
d=ORYX.Core.StencilSet.stencil(a+"EndEvent");
c=new ORYX.Core.Node({eventHandlerCallback:this.facade.raiseEvent},d);
this.facade.getCanvas().add(c);
return c
}get ,drawPath:function(f,e){var c;
...
c.dockers.last().setReferencePoint({x:e.bounds.width()/2,y:e.bounds.height()/2});
c.setProperty("oryx-temporalproperty","Leads to");
c.setProperty("oryx-exclude","Some Activity");
this.facade.getCanvas().add(c);
return c
}get });
if(!ORYX.Plugins){ORYX.Plugins=new Object()
}ORYX.Plugins.BeforePresencePattern=ORYX.Plugins.AbstractPlugin.extend({facade:undefined,construct:function(a){this.facade=a;
this.active=false;
this.raisedEventIds=[];
this.facade.offer({name:ORYX.I18N.BeforePresencePattern.name,functionality:this.showOverlay.bind(this),group:ORYX.I18N.BeforePresencePattern.group,dropDownGroupIcon:ORYX.PATH+"images/controlFlow.png",icon:ORYX.PATH+"images/PrecedencePattern.png",description:ORYX.I18N.BeforePresencePattern.desc,index:0,toggle:true,minShape:0,maxShape:0})
}get ,showOverlay:function(b,c){if(!c){this.raisedEventIds=[];
this.active=!this.active;
return
}var a={command:"undef"};
this.createPrecedencePattern(a)
}get ,createPrecedencePattern:function(b){var a=-30;
var d=this.drawStartActivity(a);
a=a+150;
var c=this.drawEndActivity(a);
this.drawPath(d,c)
}get ,drawStartActivity:function(f){var b=this.facade.getCanvas();
var c;
var e={};
e.x=f;
e.y=0;
...
this.facade.getCanvas().add(c);
return c
}get ,drawEndActivity:function(f){var b=this.facade.getCanvas();
var c;
var e={};
e.x=f;
e.y=0;
...
c.dockers.last().setDockedShape(e);
c.dockers.last().setReferencePoint({x:e.bounds.width()/2,y:e.bounds.height()/2});
c.setProperty("oryx-temporalproperty","Precedes");
this.facade.getCanvas().add(c);
return c
}get });
if(!ORYX.Plugins){ORYX.Plugins=new Object()
}ORYX.Plugins.BeforeAbsencePattern=ORYX.Plugins.AbstractPlugin.extend({facade:undefined,construct:function(a){this.facade=a;
this.active=false;
this.raisedEventIds=[];
this.facade.offer({name:ORYX.I18N.BeforeAbsencePattern.name,functionality:this.showOverlay.bind(this),group:ORYX.I18N.BeforeAbsencePattern.group,dropDownGroupIcon:ORYX.PATH+"images/controlFlow.png",icon:ORYX.PATH+"images/BeforeAbsencePattern.png",description:ORYX.I18N.BeforeAbsencePattern.desc,index:0,toggle:true,minShape:0,maxShape:0})
}get ,showOverlay:function(b,c){if(!c){this.raisedEventIds=[];
this.active=!this.active;
return
}var a={command:"undef"};
this.createBeforeAbsencePattern(a)
}get ,createBeforeAbsencePattern:function(b){var a=-30;
var d=this.drawStartEvent(a);
a=a+150;
var c=this.drawEndActivity(a);
this.drawPath(d,c)
}get ,drawStartEvent:function(f){var b=this.facade.getCanvas();
...
if(!ORYX.Plugins){ORYX.Plugins=new Object()
}ORYX.Plugins.AfterPresencePattern=ORYX.Plugins.AbstractPlugin.extend({facade:undefined,construct:function(a){this.facade=a;
this.active=false;
this.raisedEventIds=[];
this.facade.offer({name:ORYX.I18N.AfterPresencePattern.name,functionality:this.showOverlay.bind(this),group:ORYX.I18N.AfterPresencePattern.group,dropDownGroupIcon:ORYX.PATH+"images/controlFlow.png",icon:ORYX.PATH+"images/ResponsePattern.png",description:ORYX.I18N.AfterPresencePattern.desc,index:0,toggle:true,minShape:0,maxShape:0})
}get ,showOverlay:function(b,c){if(!c){this.raisedEventIds=[];
this.active=!this.active;
return
}var a={command:"undef"};
this.createResponsePattern(a)
}get ,createResponsePattern:function(b){var a=-30;
var d=this.drawStartActivity(a);
a=a+150;
var c=this.drawEndActivity(a);
this.drawPath(d,c)
...
if(!ORYX.Plugins){ORYX.Plugins=new Object()
}ORYX.Plugins.AfterAbsencePattern=ORYX.Plugins.AbstractPlugin.extend({facade:undefined,construct:function(a){this.facade=a;
this.active=false;
this.raisedEventIds=[];
this.facade.offer({name:ORYX.I18N.AfterAbsencePattern.name,functionality:this.showOverlay.bind(this),group:ORYX.I18N.AfterAbsencePattern.group,dropDownGroupIcon:ORYX.PATH+"images/controlFlow.png",icon:ORYX.PATH+"images/AfterAbsencePattern.png",description:ORYX.I18N.AfterAbsencePattern.desc,index:0,toggle:true,minShape:0,maxShape:0})
}get ,showOverlay:function(b,c){if(!c){this.raisedEventIds=[];
this.active=!this.active;
return
}var a={command:"undef"};
this.createAfterAbsencePattern(a)
}get ,createAfterAbsencePattern:function(b){var a=-30;
var d=this.drawStartActivity(a);
a=a+150;
var c=this.drawEndEvent(a);
this.drawPath(d,c)
}get ,drawStartActivity:function(f){var b=this.facade.getCanvas();
var c;
var e={};
...
if(!ORYX.Plugins){ORYX.Plugins=new Object()
}ORYX.Plugins.BetweenAbsenceTypeIPattern=ORYX.Plugins.AbstractPlugin.extend({facade:undefined,construct:function(a){this.facade=a;
this.active=false;
this.raisedEventIds=[];
this.facade.offer({name:ORYX.I18N.BetweenAbsenceTypeIPattern.name,functionality:this.showOverlay.bind(this),group:ORYX.I18N.BetweenAbsenceTypeIPattern.group,dropDownGroupIcon:ORYX.PATH+"images/controlFlow.png",icon:ORYX.PATH+"images/BetweenAbsenceTypeIPattern.png",description:ORYX.I18N.BetweenAbsenceTypeIPattern.desc,index:0,toggle:true,minShape:0,maxShape:0})
}get ,showOverlay:function(b,c){if(!c){this.raisedEventIds=[];
this.active=!this.active;
return
}var a={command:"undef"};
this.createBetweenAbsenceTypeIPattern(a)
}get ,createBetweenAbsenceTypeIPattern:function(b){var a=-30;
var d=this.drawStartActivity(a);
a=a+150;
var c=this.drawEndActivity(a);
this.drawPath(d,c)
...
if(!ORYX.Plugins){ORYX.Plugins=new Object()
}ORYX.Plugins.BetweenAbsenceTypeIIPattern=ORYX.Plugins.AbstractPlugin.extend({facade:undefined,construct:function(a){this.facade=a;
this.active=false;
this.raisedEventIds=[];
this.facade.offer({name:ORYX.I18N.BetweenAbsenceTypeIIPattern.name,functionality:this.showOverlay.bind(this),group:ORYX.I18N.BetweenAbsenceTypeIIPattern.group,dropDownGroupIcon:ORYX.PATH+"images/controlFlow.png",icon:ORYX.PATH+"images/BetweenAbsenceTypeIIPattern.png",description:ORYX.I18N.BetweenAbsenceTypeIIPattern.desc,index:0,toggle:true,minShape:0,maxShape:0})
}get ,showOverlay:function(b,c){if(!c){this.raisedEventIds=[];
this.active=!this.active;
return
}var a={command:"undef"};
this.createBetweenAbsenceTypeIIPattern(a)
}get ,createBetweenAbsenceTypeIIPattern:function(b){var a=-30;
var d=this.drawStartActivity(a);
a=a+150;
var c=this.drawEndActivity(a);
this.drawPath(d,c)
